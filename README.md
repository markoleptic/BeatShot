...
Download Development Build here (BeatShot-Windows.rar) [here](https://github.com/markoleptic/BeatShot/releases/download/v0.1.0/BeatShot_Windows.rar) or navigate to Releases on the sidebar.
