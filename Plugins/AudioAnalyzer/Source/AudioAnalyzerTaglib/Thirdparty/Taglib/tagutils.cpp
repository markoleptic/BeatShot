...
long Utils::findID3v1(TagLib::File *file)
{
  if(!file->isValid())
    return -1;
...
long Utils::findID3v2(TagLib::File *file)
{
  if(!file->isValid())
    return -1;
...
long Utils::findAPE(TagLib::File *file, long id3v1Location)
{
  if(!file->isValid())
    return -1;
