...
static TAutoConsoleVariable CVarShowDebug(
	TEXT("bs_showdebug"), 0, TEXT("Shows/clears all visual and print debug options."));


static TAutoConsoleVariable CVarPrintDebug_SpawnAreaStateInfo(
	TEXT("bs_printdebug.spawnareastateinfo"), 0,
...
static TAutoConsoleVariable CVarPrintDebug_ChooseBestActionIndex(
	TEXT("bs_printdebug.choosebestidx"), 0,
...
static TAutoConsoleVariable CVarPrintDebug_GetMaxIndex(
	TEXT("bs_printdebug.getmaxindex"), 0,
...
static TAutoConsoleVariable CVarPrintDebug_ActiveTargetPairs(
	TEXT("bs_pringdebug.activetargetpairs"), 0,
...
static TAutoConsoleVariable CVarPrintDebug_QTableInit(
	TEXT("bs_pringdebug.qtableinit"), 0,
...
static TAutoConsoleVariable CVarPrintDebug_QTableUpdate(
	TEXT("bs_printdebug.qtableupdate"), 0,
...
static TAutoConsoleVariable CVarPrintDebug_Grid(
	TEXT("bs_printdebug.grid"), 0, TEXT("Toggles printing various grid-distribution related info."));


static TAutoConsoleVariable CVarShowDebug_ReinforcementLearningWidget(
	TEXT("bs_showdebug.rlwidget"), FString("avg"),
...
static TAutoConsoleVariable CVarShowDebug_AllSpawnAreas(
	TEXT("bs_showdebug.allspawnareas"), 0, TEXT("Toggles showing debug boxes for all Spawn Areas."));


static TAutoConsoleVariable CVarShowDebug_RemovedFromExtremaChange(
	TEXT("bs_showdebug.removedextrema"), 0,
...
static TAutoConsoleVariable CVarShowDebug_ValidInvalid(
	TEXT("bs_showdebug.validinvalid"), 0,
...
static TAutoConsoleVariable CVarShowDebug_SpawnableSpawnAreas(
	TEXT("bs_showdebug.spawnable"), 0, TEXT("Toggles showing debug boxes for valid spawnable spawn areas."));


static TAutoConsoleVariable CVarShowDebug_ActivatableSpawnAreas(
	TEXT("bs_showdebug.activatable"), 0, TEXT("Toggles showing debug boxes for valid activatable spawn areas."));


static TAutoConsoleVariable CVarShowDebug_ActivatedSpawnAreas(
	TEXT("bs_showdebug.activated"), 0, TEXT("Toggles showing debug boxes for activated spawn areas."));


static TAutoConsoleVariable CVarShowDebug_DeactivatedSpawnAreas(
	TEXT("bs_showdebug.deactivated"), 0, TEXT("Toggles showing debug boxes for deactivated spawn areas."));


static TAutoConsoleVariable CVarShowDebug_RecentSpawnAreas(
	TEXT("bs_showdebug.recent"), 0, TEXT("Toggles showing debug boxes for recent spawn areas."));


static TAutoConsoleVariable CVarShowDebug_NonAdjacent(
	TEXT("bs_showdebug.nonadjacent"), 0,
...
static TAutoConsoleVariable CVarShowDebug_FrontSpotLight(
	TEXT("bs_showdebug.frontspotlight"), 0, TEXT("If night, shows toggles showing the front spotlight."));
