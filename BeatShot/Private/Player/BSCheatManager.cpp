...
{
	static TAutoConsoleVariable CVarCheat_AimBot(
		TEXT("bs_cheat.aimbot"),
		FString(),
	...
	static TAutoConsoleVariable CVarPrintDebug_SpawnAreaStateInfo(
		TEXT("bs_printdebug.spawnareastateinfo"),
		0,
		TEXT("Toggles printing the number managed, activated, and recent Spawn Areas."));


	static TAutoConsoleVariable CVarPrintDebug_ChooseBestActionIndex(
		TEXT("bs_printdebug.choosebestidx"),
		0,
		TEXT("Toggles printing info about the Reinforcement Learning Component choosing the Best Action Index."));


	static TAutoConsoleVariable CVarPrintDebug_GetMaxIndex(
		TEXT("bs_printdebug.getmaxindex"),
		0,
		TEXT("Toggles printing the Reinforcement Learning Component's intermediate values when finding the max "
			"action index."));


	static TAutoConsoleVariable CVarPrintDebug_ActiveTargetPairs(
		TEXT("bs_pringdebug.activetargetpairs"),
		0,
		TEXT("Toggles printing the target pairs that are added to the RL Component's ActiveTargetPairs."));


	static TAutoConsoleVariable CVarPrintDebug_QTableInit(
		TEXT("bs_pringdebug.qtableinit"),
		0,
		TEXT("Toggles printing initialization info about the QTable in the RL Component."));


	static TAutoConsoleVariable CVarPrintDebug_QTableUpdate(
		TEXT("bs_printdebug.qtableupdate"),
		0,
	...
	static TAutoConsoleVariable CVarPrintDebug_Grid(
		TEXT("bs_printdebug.grid"),
		0,
		TEXT("Toggles printing various grid-distribution related info."));


	static TAutoConsoleVariable CVarShowDebug_ReinforcementLearningWidget(
		TEXT("bs_showdebug.rlwidget"),
		FString("avg"),
	...
	static TAutoConsoleVariable CVarShowDebug_SpawnBox(
		TEXT("bs_showdebug.spawnbox"),
		0,
		TEXT("Draw debug boxes for the SpawnBox and the StaticExtentsBox."));


	static TAutoConsoleVariable CVarShowDebug_SpawnVolume(
		TEXT("bs_showdebug.spawnvolume"),
		0,
		TEXT("Draw debug box for the SpawnVolume."));


	static TAutoConsoleVariable CVarShowDebug_DirectionalBoxes(
		TEXT("bs_showdebug.dirboxes"),
		0,
		TEXT("Draw debug boxes for the 6 directional boxes.\n") TEXT("X: Red\n") TEXT("Y: Green\n") TEXT("Z: Blue\n"));


	static TAutoConsoleVariable CVarShowDebug_MovingTargetDirectionModeAny(
		TEXT("bs_showdebug.movingany"),
		0,
		TEXT("Draw debug boxes showing sectors for moving target direction mode any.\n"));


	static TAutoConsoleVariable CVarShowDebug_AllSpawnAreas(
		TEXT("bs_showdebug.allspawnareas"),
		0,
		TEXT("Toggles showing debug boxes for all Spawn Areas."));


	static TAutoConsoleVariable CVarShowDebug_RemovedFromExtremaChange(
		TEXT("bs_showdebug.removedextrema"),
		0,
		TEXT("Toggles showing debug boxes for removed Spawn Areas due to BoxBounds."));


	static TAutoConsoleVariable CVarShowDebug_ValidInvalid(
		TEXT("bs_showdebug.validinvalid"),
		0,
		TEXT("Toggles showing debug boxes for all spawn areas removed due to overlap."));


	static TAutoConsoleVariable CVarShowDebug_SpawnableSpawnAreas(
		TEXT("bs_showdebug.spawnable"),
		0,
		TEXT("Toggles showing debug boxes for valid spawnable spawn areas."));


	static TAutoConsoleVariable CVarShowDebug_ActivatableSpawnAreas(
		TEXT("bs_showdebug.activatable"),
		0,
		TEXT("Toggles showing debug boxes for valid activatable spawn areas."));


	static TAutoConsoleVariable CVarShowDebug_ActivatedSpawnAreas(
		TEXT("bs_showdebug.activated"),
		0,
		TEXT("Toggles showing debug boxes for activated spawn areas."));


	static TAutoConsoleVariable CVarShowDebug_DeactivatedSpawnAreas(
		TEXT("bs_showdebug.deactivated"),
		0,
		TEXT("Toggles showing debug boxes for deactivated spawn areas."));


	static TAutoConsoleVariable CVarShowDebug_RecentSpawnAreas(
		TEXT("bs_showdebug.recent"),
		0,
		TEXT("Toggles showing debug boxes for recent spawn areas."));


	static TAutoConsoleVariable CVarShowDebug_NonAdjacent(
		TEXT("bs_showdebug.nonadjacent"),
		0,
	...
	static TAutoConsoleVariable CVarShowDebug_FrontSpotLight(
		TEXT("bs_showdebug.frontspotlight"),
		0,
		TEXT("If night, shows toggles showing the front spotlight."));


	static TAutoConsoleVariable CVarSetTimeOfDay(
		TEXT("bs_settimeofday"),
		FString("day"),
...
void UBSCheatManager::InitCheatManager()
{
	...
	BIND_BS_CVAR(CVarShowDebug_ReinforcementLearningWidget,
	             this,
	...
	BIND_BS_CVAR(CVarShowDebug_MovingTargetDirectionModeAny,
	             this,
	             &UBSCheatManager::ShowDebug_MovingTargetDirectionModeAny);

	BIND_BS_COMP_CVAR(CVarShowDebug_AllSpawnAreas,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::bShowDebug_AllSpawnAreas);
	BIND_BS_COMP_CVAR(CVarShowDebug_ValidInvalid,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::bShowDebug_ValidInvalidSpawnAreas);
	BIND_BS_COMP_CVAR(CVarShowDebug_SpawnableSpawnAreas,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::bShowDebug_SpawnableSpawnAreas);
	BIND_BS_COMP_CVAR(CVarShowDebug_ActivatableSpawnAreas,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::bShowDebug_ActivatableSpawnAreas);
	BIND_BS_COMP_CVAR(CVarShowDebug_ActivatedSpawnAreas,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::bShowDebug_ActivatedSpawnAreas);
	BIND_BS_COMP_CVAR(CVarShowDebug_DeactivatedSpawnAreas,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::bShowDebug_DeactivatedSpawnAreas);
	BIND_BS_COMP_CVAR(CVarShowDebug_RecentSpawnAreas,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::bShowDebug_RecentSpawnAreas);
	BIND_BS_COMP_CVAR(CVarShowDebug_RemovedFromExtremaChange,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::bShowDebug_RemovedFromExtremaChange);
	BIND_BS_COMP_CVAR(CVarShowDebug_NonAdjacent,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::bShowDebug_NonAdjacent);
	BIND_BS_COMP_CVAR(CVarShowDebug_Vertices,
	                  this,
	                  SetComponentDebugValue,
	                  &USpawnAreaManagerComponent::ShowDebug_Vertices);
	BIND_BS_COMP_CVAR(CVarPrintDebug_SpawnAreaStateInfo,
	                  this,
	                  SetComponentDebugValue,
	...
	BIND_BS_COMP_CVAR(CVarPrintDebug_ChooseBestActionIndex,
	                  this,
	                  SetComponentDebugValue,
	                  &UReinforcementLearningComponent::bPrintDebug_ChooseActionIndex);
	BIND_BS_COMP_CVAR(CVarPrintDebug_GetMaxIndex,
	                  this,
	                  SetComponentDebugValue,
	                  &UReinforcementLearningComponent::bPrintDebug_GetMaxIndex);
	BIND_BS_COMP_CVAR(CVarPrintDebug_QTableUpdate,
	                  this,
	                  SetComponentDebugValue,
	                  &UReinforcementLearningComponent::bPrintDebug_QTableUpdate);
	BIND_BS_COMP_CVAR(CVarPrintDebug_QTableInit,
	                  this,
	                  SetComponentDebugValue,
	                  &UReinforcementLearningComponent::bPrintDebug_QTableInit);
	BIND_BS_COMP_CVAR(CVarPrintDebug_ActiveTargetPairs,
	                  this,
	                  SetComponentDebugValue,
...
void UBSCheatManager::ShowDebug_ReinforcementLearningWidget(IConsoleVariable* Variable)
{
	...
	if (bShowWidget)
	{
		if (bAvg)
		{
			Controller->ShowQTableWidget(TargetManager->RLComponent->OnQTableUpdate,
			                             5,
			                             5,
