...
public:
	...
	TSet<FVector> GetOccupiedVertices() const { return OccupiedVertices; }
...
private:
	...
	void RemoveOverlappingSpawnAreas(TArray<USpawnArea*>& ValidSpawnAreas, const TArray<USpawnArea*>& ChosenSpawnAreas,
