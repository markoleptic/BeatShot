...
void UCustomGameModesWidget_Spawning::InitComponent(FBSConfig* InConfigPtr,
...
void UCustomGameModesWidget_Spawning::NativeConstruct()
{
	...
	CheckBoxOption_ApplyImmunityOnSpawn->CheckBox->OnCheckStateChanged.AddDynamic(this,
		&ThisClass::OnCheckStateChanged_ApplyImmunityOnSpawn);
	...
	CheckBoxOption_ApplyVelocityWhenSpawned->CheckBox->OnCheckStateChanged.AddDynamic(this,
		&ThisClass::OnCheckStateChanged_ApplyVelocityWhenSpawned);
...
void UCustomGameModesWidget_Spawning::UpdateOptionsFromConfig()
{
	...
	UpdateValueIfDifferent(CheckBoxOption_ConstantSpawnedTargetVelocity,
	...
	UpdateDependentOptions_ApplyVelocityWhenSpawned(BSConfig->TargetConfig.bApplyVelocityWhenSpawned,
		BSConfig->TargetConfig.MinSpawnedTargetSpeed == BSConfig->TargetConfig.MaxSpawnedTargetSpeed);
...
{
	CheckBoxOption_ApplyVelocityWhenSpawned->AddWarningTooltipData(FTooltipData("Invalid_Velocity_MTDM_None",
		ETooltipImageType::Caution)).BindLambda([this]()
	{
		return BSConfig->TargetConfig.bApplyVelocityWhenSpawned && BSConfig->TargetConfig.MovingTargetDirectionMode ==
...
void UCustomGameModesWidget_Spawning::UpdateDependentOptions_ApplyVelocityWhenSpawned(
	const bool bApplyVelocityWhenSpawned, const bool bConstantSpawnedTargetVelocity)
{
...
void UCustomGameModesWidget_Spawning::UpdateDependentOptions_ConstantSpawnedTargetVelocity(
	const bool bApplyVelocityWhenSpawned, const bool bInConstant)
{
	if (bApplyVelocityWhenSpawned)
	{
		if (bInConstant)
...
void UCustomGameModesWidget_Spawning::OnSliderTextBoxValueChanged(USliderTextBoxOptionWidget* Widget, const float Value)
{
	...
	else if (Widget == SliderTextBoxOption_SpawnedTargetVelocity && SliderTextBoxOption_SpawnedTargetVelocity->
