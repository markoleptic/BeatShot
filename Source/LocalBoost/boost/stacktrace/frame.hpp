...
#include <LocalBoost/boost/stacktrace/safe_dump_to.hpp> // boost::stacktrace::detail::native_frame_ptr_t

#include <LocalBoost/boost/stacktrace/detail/frame_decl.hpp>
...
#       include <LocalBoost/boost/stacktrace/detail/frame_noop.ipp>
#   elif defined(BOOST_MSVC) || defined(BOOST_STACKTRACE_USE_WINDBG) || defined(BOOST_STACKTRACE_USE_WINDBG_CACHED)
#       include <LocalBoost/boost/stacktrace/detail/frame_msvc.ipp>
#   else
#       include <LocalBoost/boost/stacktrace/detail/frame_unwind.ipp>
#   endif
#endif
/// @endcond
