...
#include <LocalBoost/boost/stacktrace/detail/push_options.h>
...
#include <LocalBoost/boost/stacktrace/detail/pop_options.h>

#if !defined(BOOST_STACKTRACE_LINK) || defined(BOOST_STACKTRACE_INTERNAL_BUILD_LIBS)
#   if defined(BOOST_STACKTRACE_USE_NOOP)
#       include <LocalBoost/boost/stacktrace/detail/safe_dump_noop.ipp>
#       include <LocalBoost/boost/stacktrace/detail/collect_noop.ipp>
#   else
#       if defined(BOOST_WINDOWS)
#           include <LocalBoost/boost/stacktrace/detail/safe_dump_win.ipp>
#       else
#           include <LocalBoost/boost/stacktrace/detail/safe_dump_posix.ipp>
#       endif
#       if defined(BOOST_WINDOWS) && !defined(BOOST_WINAPI_IS_MINGW) // MinGW does not provide RtlCaptureStackBackTrace. MinGW-w64 does.
#           include <LocalBoost/boost/stacktrace/detail/collect_msvc.ipp>
#       else
#           include <LocalBoost/boost/stacktrace/detail/collect_unwind.ipp>
#       endif
#   endif
#endif
