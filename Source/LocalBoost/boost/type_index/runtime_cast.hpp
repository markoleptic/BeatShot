...
#include <LocalBoost/boost/type_index/runtime_cast/register_runtime_class.hpp>
#include <LocalBoost/boost/type_index/runtime_cast/pointer_cast.hpp>
#include <LocalBoost/boost/type_index/runtime_cast/reference_cast.hpp>
