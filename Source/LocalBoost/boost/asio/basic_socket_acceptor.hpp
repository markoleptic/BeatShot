...
# include <LocalBoost/boost/asio/detail/null_socket_service.hpp>
#elif defined(BOOST_ASIO_HAS_IOCP)
# include <LocalBoost/boost/asio/detail/win_iocp_socket_service.hpp>
#elif defined(BOOST_ASIO_HAS_IO_URING_AS_DEFAULT)
# include <LocalBoost/boost/asio/detail/io_uring_socket_service.hpp>
#else
# include <LocalBoost/boost/asio/detail/reactive_socket_service.hpp>
#endif
