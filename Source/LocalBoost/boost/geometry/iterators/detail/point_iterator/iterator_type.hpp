...
#include <LocalBoost/boost/geometry/iterators/detail/point_iterator/value_type.hpp>

#include <LocalBoost/boost/geometry/iterators/dispatch/point_iterator.hpp>
