...
#include <LocalBoost/boost/accumulators/accumulators.hpp>
...
#include <LocalBoost/boost/accumulators/statistics/rolling_mean.hpp>
#include <LocalBoost/boost/accumulators/statistics/rolling_moment.hpp>
