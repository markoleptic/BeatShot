...
#   include <LocalBoost/boost/mpl/bind_fwd.hpp>
...
#   include <LocalBoost/boost/mpl/apply_wrap.hpp>
#   include <LocalBoost/boost/mpl/limits/arity.hpp>
#   include <LocalBoost/boost/mpl/aux_/na.hpp>
#   include <LocalBoost/boost/mpl/aux_/arity_spec.hpp>
#   include <LocalBoost/boost/mpl/aux_/type_wrapper.hpp>
#   include <LocalBoost/boost/mpl/aux_/yes_no.hpp>
#   if defined(BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION)
#       include <LocalBoost/boost/type_traits/is_reference.hpp>
#   endif 
#endif

#include <LocalBoost/boost/mpl/aux_/config/bind.hpp>
#include <LocalBoost/boost/mpl/aux_/config/static_constant.hpp>
...
#   include <LocalBoost/boost/mpl/aux_/preprocessor/params.hpp>
#   include <LocalBoost/boost/mpl/aux_/preprocessor/default_params.hpp>
#   include <LocalBoost/boost/mpl/aux_/preprocessor/def_params_tail.hpp>
#   include <LocalBoost/boost/mpl/aux_/preprocessor/partial_spec_params.hpp>
#   include <LocalBoost/boost/mpl/aux_/preprocessor/ext_params.hpp>
#   include <LocalBoost/boost/mpl/aux_/preprocessor/repeat.hpp>
#   include <LocalBoost/boost/mpl/aux_/preprocessor/enum.hpp>
#   include <LocalBoost/boost/mpl/aux_/preprocessor/add.hpp>
#   include <LocalBoost/boost/mpl/aux_/config/dmc_ambiguous_ctps.hpp>
#   include <LocalBoost/boost/mpl/aux_/config/ctps.hpp>
#   include <LocalBoost/boost/mpl/aux_/config/ttp.hpp>
#   include <LocalBoost/boost/mpl/aux_/config/dtp.hpp>
#   include <LocalBoost/boost/mpl/aux_/nttp_decl.hpp>

#   include <LocalBoost/boost/preprocessor/iterate.hpp>
#   include <LocalBoost/boost/preprocessor/comma_if.hpp>
#   include <LocalBoost/boost/preprocessor/cat.hpp>
#   include <LocalBoost/boost/preprocessor/inc.hpp>
...
#include <LocalBoost/boost/mpl/aux_/count_args.hpp>
}
