...
#include <LocalBoost/boost/filesystem/operations.hpp>
#include <LocalBoost/boost/lexical_cast.hpp>
#include <LocalBoost/boost/spirit/include/classic_multi_pass.hpp>
#include <LocalBoost/boost/spirit/include/classic_parse_tree_utils.hpp>

#include <LocalBoost/boost/wave/wave_config.hpp>
#include <LocalBoost/boost/pool/pool_alloc.hpp>

#include <LocalBoost/boost/wave/util/insert_whitespace_detection.hpp>
#include <LocalBoost/boost/wave/util/macro_helpers.hpp>
#include <LocalBoost/boost/wave/util/cpp_macromap_utils.hpp>
#include <LocalBoost/boost/wave/util/interpret_pragma.hpp>
#include <LocalBoost/boost/wave/util/transform_iterator.hpp>
#include <LocalBoost/boost/wave/util/functor_input.hpp>
#include <LocalBoost/boost/wave/util/filesystem_compatibility.hpp>

#include <LocalBoost/boost/wave/grammars/cpp_grammar_gen.hpp>
#include <LocalBoost/boost/wave/grammars/cpp_expression_grammar_gen.hpp>
#if BOOST_WAVE_ENABLE_COMMANDLINE_MACROS != 0
#include <LocalBoost/boost/wave/grammars/cpp_predef_macros_gen.hpp>
#endif

#include <LocalBoost/boost/wave/whitespace_handling.hpp>
#include <LocalBoost/boost/wave/cpp_iteration_context.hpp>
#include <LocalBoost/boost/wave/cpp_exceptions.hpp>
#include <LocalBoost/boost/wave/language_support.hpp>
