...
#include <LocalBoost/boost/serialization/shared_ptr.hpp>
#endif
...
#include <LocalBoost/boost/wave/util/time_conversion_helper.hpp>
#include <LocalBoost/boost/wave/util/unput_queue_iterator.hpp>
#include <LocalBoost/boost/wave/util/macro_helpers.hpp>
#include <LocalBoost/boost/wave/util/macro_definition.hpp>
#include <LocalBoost/boost/wave/util/symbol_table.hpp>
#include <LocalBoost/boost/wave/util/cpp_macromap_utils.hpp>
#include <LocalBoost/boost/wave/util/cpp_macromap_predef.hpp>
#include <LocalBoost/boost/wave/util/filesystem_compatibility.hpp>
#include <LocalBoost/boost/wave/grammars/cpp_defined_grammar_gen.hpp>
#if BOOST_WAVE_SUPPORT_HAS_INCLUDE != 0
#include <LocalBoost/boost/wave/grammars/cpp_has_include_grammar_gen.hpp>
#endif

#include <LocalBoost/boost/wave/wave_version.hpp>
