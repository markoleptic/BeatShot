...
#include <LocalBoost/boost/poly_collection/detail/is_equality_comparable.hpp>
#include <LocalBoost/boost/poly_collection/detail/is_nothrow_eq_comparable.hpp>
