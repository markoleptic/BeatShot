...
#include <LocalBoost/boost/poly_collection/function_collection_fwd.hpp>
#include <LocalBoost/boost/poly_collection/detail/function_model.hpp>
#include <LocalBoost/boost/poly_collection/detail/poly_collection.hpp>
#include <utility>
