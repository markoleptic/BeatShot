...
#include <LocalBoost/boost/fusion/include/fold.hpp>
#include <LocalBoost/boost/fusion/include/reverse_fold.hpp>
...
namespace boost { namespace proto
{
    namespace detail
    {
        ...
        #include <LocalBoost/boost/proto/transform/detail/fold_impl.hpp>
