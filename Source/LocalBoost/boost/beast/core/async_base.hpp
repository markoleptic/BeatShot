...
#include <LocalBoost/boost/beast/core/detail/allocator.hpp>
#include <LocalBoost/boost/beast/core/detail/async_base.hpp>
#include <LocalBoost/boost/beast/core/detail/filtering_cancellation_slot.hpp>
#include <LocalBoost/boost/beast/core/detail/work_guard.hpp>
...
#include <LocalBoost/boost/core/exchange.hpp>
...
/** Base class to provide completion handler boilerplate for composed operations.
                ...
                void(error_code)>::return_type
    {
        ...
        struct op : base_type, boost::asio::coroutine
        {
            ...
            #include <LocalBoost/boost/asio/yield.hpp>
            ...
            #include <LocalBoost/boost/asio/unyield.hpp>
        };
...
#include <LocalBoost/boost/beast/core/impl/async_base.hpp>
