...
#include <LocalBoost/boost/atomic/detail/interlocked.hpp>
...
#include <LocalBoost/boost/atomic/detail/type_traits/make_signed.hpp>
#include <LocalBoost/boost/atomic/detail/capabilities.hpp>
#if defined(BOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B) || defined(BOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B)
#include <LocalBoost/boost/cstdint.hpp>
#include <LocalBoost/boost/atomic/detail/cas_based_exchange.hpp>
#include <LocalBoost/boost/atomic/detail/core_ops_cas_based.hpp>
#endif
#include <LocalBoost/boost/atomic/detail/ops_msvc_common.hpp>
...
#include <LocalBoost/boost/atomic/detail/extending_cas_based_arithmetic.hpp>
#endif
