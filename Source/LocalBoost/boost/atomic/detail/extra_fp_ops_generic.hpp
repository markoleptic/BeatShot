...
#include <LocalBoost/boost/atomic/detail/extra_fp_operations_fwd.hpp>
#include <LocalBoost/boost/atomic/detail/type_traits/is_iec559.hpp>
#include <LocalBoost/boost/atomic/detail/type_traits/is_integral.hpp>
