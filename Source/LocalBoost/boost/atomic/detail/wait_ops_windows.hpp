...
#include <LocalBoost/boost/winapi/wait_constants.hpp>
#include <LocalBoost/boost/atomic/detail/wait_operations_fwd.hpp>
#include <LocalBoost/boost/atomic/detail/wait_capabilities.hpp>
#if defined(BOOST_ATOMIC_DETAIL_WINDOWS_HAS_WAIT_ON_ADDRESS)
#include <LocalBoost/boost/winapi/wait_on_address.hpp>
...
#include <LocalBoost/boost/config/auto_link.hpp>
...
#include <cstddef>
#include <LocalBoost/boost/atomic/detail/wait_on_address.hpp>
#include <LocalBoost/boost/atomic/detail/wait_ops_generic.hpp>
