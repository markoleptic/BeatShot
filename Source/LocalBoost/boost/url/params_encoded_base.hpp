...
#include <LocalBoost/boost/url/detail/params_iter_impl.hpp>
#include <LocalBoost/boost/url/detail/url_impl.hpp>
#include <iosfwd>
...
#include <LocalBoost/boost/url/impl/params_encoded_base.hpp>
