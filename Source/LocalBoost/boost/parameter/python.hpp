...
# include <LocalBoost/boost/mpl/prior.hpp>
# include <LocalBoost/boost/mpl/shift_right.hpp>
# include <LocalBoost/boost/mpl/shift_left.hpp>
...
# include <LocalBoost/boost/python/def.hpp>
# include <LocalBoost/boost/python/make_constructor.hpp>
# include <LocalBoost/boost/python/init.hpp>
# include <LocalBoost/boost/python/to_python_converter.hpp>
# include <LocalBoost/boost/parameter/aux_/maybe.hpp>
# include <LocalBoost/boost/parameter/aux_/python/invoker.hpp>
