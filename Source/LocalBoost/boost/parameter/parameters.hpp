...
#include <LocalBoost/boost/parameter/aux_/arg_list.hpp>
#include <utility>
...
#include <LocalBoost/boost/parameter/aux_/pack/make_arg_list.hpp>
#include <LocalBoost/boost/parameter/aux_/pack/make_parameter_spec_items.hpp>
#include <LocalBoost/boost/parameter/aux_/pack/tag_keyword_arg.hpp>
#include <LocalBoost/boost/parameter/aux_/pack/tag_template_keyword_arg.hpp>

#if defined(BOOST_PARAMETER_CAN_USE_MP11)
#include <LocalBoost/boost/mp11/integral.hpp>
#include <LocalBoost/boost/mp11/list.hpp>
#else
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
//#include <LocalBoost/boost/mp11/mpl.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::boost::mp11::mp_list
#else
#include <LocalBoost/boost/fusion/container/list/list_fwd.hpp>
...
#include <LocalBoost/boost/fusion/container/list.hpp>
#include <LocalBoost/boost/fusion/mpl.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::boost::fusion::list
#else
#include <LocalBoost/boost/fusion/container/deque/deque_fwd.hpp>

#if defined(BOOST_FUSION_HAS_VARIADIC_DEQUE)
#include <LocalBoost/boost/fusion/container/deque.hpp>
#include <LocalBoost/boost/fusion/mpl.hpp>
...
#include <LocalBoost/boost/parameter/aux_/arg_list.hpp>
#include <LocalBoost/boost/parameter/aux_/pack/make_arg_list.hpp>
#include <LocalBoost/boost/parameter/aux_/pack/make_items.hpp>
#include <LocalBoost/boost/parameter/aux_/pack/make_deduced_items.hpp>
#include <LocalBoost/boost/parameter/aux_/pack/tag_template_keyword_arg.hpp>
#include <LocalBoost/boost/parameter/aux_/preprocessor/binary_seq_for_each.hpp>
#include <LocalBoost/boost/preprocessor/arithmetic/inc.hpp>
#include <LocalBoost/boost/preprocessor/repetition/enum_shifted.hpp>
#include <LocalBoost/boost/preprocessor/repetition/repeat.hpp>
#include <LocalBoost/boost/preprocessor/selection/min.hpp>

#if ( \
        BOOST_PARAMETER_EXPONENTIAL_OVERLOAD_THRESHOLD_ARITY < \
        BOOST_PARAMETER_MAX_ARITY \
    )
#include <LocalBoost/boost/parameter/aux_/pack/tag_keyword_arg_ref.hpp>
#include <LocalBoost/boost/mpl/pair.hpp>
#include <LocalBoost/boost/preprocessor/arithmetic/dec.hpp>
#include <LocalBoost/boost/preprocessor/arithmetic/sub.hpp>
#include <LocalBoost/boost/preprocessor/facilities/intercept.hpp>
...
#include <LocalBoost/boost/parameter/aux_/preprocessor/no_perfect_forwarding_begin.hpp>
...
#include <LocalBoost/boost/parameter/aux_/preprocessor/no_perfect_forwarding_end.hpp>
