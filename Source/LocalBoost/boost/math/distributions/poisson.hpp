...
#include <LocalBoost/boost/math/special_functions/trunc.hpp> // for incomplete gamma. gamma_q
...
#include <LocalBoost/boost/math/special_functions/factorials.hpp> // factorials.
#include <LocalBoost/boost/math/tools/roots.hpp> // for root finding.
#include <LocalBoost/boost/math/distributions/detail/inv_discrete_quantile.hpp>
