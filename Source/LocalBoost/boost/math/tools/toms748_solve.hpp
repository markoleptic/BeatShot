...
#  define BOOST_MATH_LOGGER_include <LocalBoost/boost/math/tools/iteration_logger.hpp>
                           ...
                           unsigned count)
{
   ...
   //
   // Vertex_BottomLeft d must lie outside of the interval [a,b], it is the third
