...
#include <LocalBoost/boost/math_fwd.hpp>
...
#include <LocalBoost/boost/math/special_functions/sinc.hpp>    // for the Sinus cardinal
#include <LocalBoost/boost/math/special_functions/sinhc.hpp>    // for the Hyperbolic Sinus cardinal
