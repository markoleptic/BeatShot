...
#include <LocalBoost/boost/bind/bind.hpp>      // for boost::bind
#include <LocalBoost/boost/range/begin.hpp>    // for boost::begin(range)
#include <LocalBoost/boost/range/end.hpp>      // for boost::end(range)
