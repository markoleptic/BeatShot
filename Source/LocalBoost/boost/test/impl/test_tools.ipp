...
// Boost.Test
#include <LocalBoost/boost/test/test_tools.hpp>
#include <LocalBoost/boost/test/unit_test_log.hpp>
#include <LocalBoost/boost/test/tools/context.hpp>
#include <LocalBoost/boost/test/tools/output_test_stream.hpp>
...
#include <LocalBoost/boost/test/execution_monitor.hpp> // execution_aborted
