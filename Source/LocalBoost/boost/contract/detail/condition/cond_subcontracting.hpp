...
#include <LocalBoost/boost/contract/core/config.hpp>
#if     !defined(BOOST_CONTRACT_NO_PRECONDITIONS) || \
        !defined(BOOST_CONTRACT_NO_POSTCONDITIONS) || \
        !defined(BOOST_CONTRACT_NO_EXCEPTS)
    #include <LocalBoost/boost/contract/core/exception.hpp>
#endif
#include <LocalBoost/boost/contract/detail/condition/cond_inv.hpp>
#include <LocalBoost/boost/contract/detail/decl.hpp>
#include <LocalBoost/boost/contract/detail/tvariadic.hpp>
#ifndef BOOST_CONTRACT_NO_CONDITIONS
    #include <LocalBoost/boost/contract/core/virtual.hpp>
    #include <LocalBoost/boost/contract/core/access.hpp>
    #include <LocalBoost/boost/contract/detail/type_traits/optional.hpp>
    #include <LocalBoost/boost/contract/detail/type_traits/member_function_types.hpp>
    #include <LocalBoost/boost/contract/detail/debug.hpp>
    #include <LocalBoost/boost/contract/detail/none.hpp>
    #include <LocalBoost/boost/contract/detail/name.hpp>
