...
#include <LocalBoost/boost/type_index.hpp>

#include <LocalBoost/boost/variant/detail/config.hpp>
#include <LocalBoost/boost/mpl/aux_/value_wknd.hpp>

#include <LocalBoost/boost/variant/variant_fwd.hpp>
#include <LocalBoost/boost/variant/detail/backup_holder.hpp>
#include <LocalBoost/boost/variant/detail/enable_recursive_fwd.hpp>
#include <LocalBoost/boost/variant/detail/forced_return.hpp>
#include <LocalBoost/boost/variant/detail/initializer.hpp>
#include <LocalBoost/boost/variant/detail/make_variant_list.hpp>
#include <LocalBoost/boost/variant/detail/over_sequence.hpp>
#include <LocalBoost/boost/variant/detail/visitation_impl.hpp>
#include <LocalBoost/boost/variant/detail/hash_variant.hpp>
#include <LocalBoost/boost/variant/detail/std_hash.hpp>

#include <LocalBoost/boost/variant/detail/move.hpp>

#include <LocalBoost/boost/detail/reference_content.hpp>
#include <LocalBoost/boost/blank.hpp>
#include <LocalBoost/boost/integer/common_factor_ct.hpp>
#include <LocalBoost/boost/static_assert.hpp>
#include <LocalBoost/boost/preprocessor/cat.hpp>
#include <LocalBoost/boost/preprocessor/repeat.hpp>
...
#include <LocalBoost/boost/core/no_exceptions_support.hpp>
#include <LocalBoost/boost/core/enable_if.hpp>
#include <LocalBoost/boost/variant/recursive_wrapper_fwd.hpp>
#include <LocalBoost/boost/variant/static_visitor.hpp>
...
#include <LocalBoost/boost/mpl/find_if.hpp>
...
#include <LocalBoost/boost/mpl/insert_range.hpp>
#include <LocalBoost/boost/mpl/int.hpp>
#include <LocalBoost/boost/mpl/is_sequence.hpp>
#include <LocalBoost/boost/mpl/iterator_range.hpp>
#include <LocalBoost/boost/mpl/iter_fold_if.hpp>
#include <LocalBoost/boost/mpl/list.hpp>
#include <LocalBoost/boost/mpl/logical.hpp>
#include <LocalBoost/boost/mpl/max_element.hpp>
#include <LocalBoost/boost/mpl/next.hpp>
#include <LocalBoost/boost/mpl/not.hpp>
#include <LocalBoost/boost/mpl/pair.hpp>
#include <LocalBoost/boost/mpl/protect.hpp>
#include <LocalBoost/boost/mpl/push_front.hpp>
#include <LocalBoost/boost/mpl/same_as.hpp>
#include <LocalBoost/boost/mpl/size_t.hpp>
#include <LocalBoost/boost/mpl/sizeof.hpp>
...
#   include <LocalBoost/boost/mpl/eval_if.hpp>
#   include <LocalBoost/boost/mpl/equal_to.hpp>
#   include <LocalBoost/boost/mpl/identity.hpp>
#   include <LocalBoost/boost/mpl/int.hpp>
#   include <LocalBoost/boost/mpl/if.hpp>
#   include <LocalBoost/boost/mpl/less.hpp>
#   include <LocalBoost/boost/mpl/long.hpp>
#   include <LocalBoost/boost/mpl/O1_size.hpp>
#endif
...
#include <LocalBoost/boost/variant/detail/variant_io.hpp>
