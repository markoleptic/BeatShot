...
#include <LocalBoost/boost/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC, etc
...
#include <LocalBoost/boost/call_traits.hpp> // for boost::call_traits
#include <LocalBoost/boost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <LocalBoost/boost/assert.hpp>      // for BOOST_ASSERT
#include <LocalBoost/boost/integer/common_factor_rt.hpp> // for boost::integer::gcd, lcm
#include <limits>                // for std::numeric_limits
#include <LocalBoost/boost/static_assert.hpp>  // for BOOST_STATIC_ASSERT
