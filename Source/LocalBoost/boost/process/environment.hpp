...
#include <LocalBoost/boost/algorithm/string/case_conv.hpp>
#include <LocalBoost/boost/iterator/transform_iterator.hpp>
#include <LocalBoost/boost/process/filesystem.hpp>

#if defined(BOOST_POSIX_API)
#include <LocalBoost/boost/process/detail/posix/environment.hpp>
#elif defined(BOOST_WINDOWS_API)
#include <LocalBoost/boost/process/detail/windows/environment.hpp>
#endif
