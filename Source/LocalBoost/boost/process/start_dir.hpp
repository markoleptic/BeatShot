...
#include <LocalBoost/boost/process/locale.hpp>
#include <LocalBoost/boost/process/detail/traits/wchar_t.hpp>

#if defined (BOOST_POSIX_API)
#include <LocalBoost/boost/process/detail/posix/start_dir.hpp>
#elif defined (BOOST_WINDOWS_API)
#include <LocalBoost/boost/process/detail/windows/start_dir.hpp>
#endif
