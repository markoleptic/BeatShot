...
#include <LocalBoost/boost/process/detail/posix/executor.hpp>
#elif defined(BOOST_WINDOWS_API)
#include <LocalBoost/boost/process/detail/windows/executor.hpp>
#endif

#include <LocalBoost/boost/process/detail/basic_cmd.hpp>
#include <LocalBoost/boost/process/detail/handler.hpp>

#include <LocalBoost/boost/fusion/view.hpp>
#include <LocalBoost/boost/fusion/container.hpp>
#include <LocalBoost/boost/fusion/sequence.hpp>
#include <LocalBoost/boost/fusion/tuple.hpp>
