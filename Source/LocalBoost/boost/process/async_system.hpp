...
#include <LocalBoost/boost/process/async.hpp>
#include <LocalBoost/boost/process/child.hpp>
#include <LocalBoost/boost/process/detail/async_handler.hpp>
#include <LocalBoost/boost/process/detail/execute_impl.hpp>
#include <type_traits>
#include <memory>
...
#include <LocalBoost/boost/process/posix.hpp>
#endif
