...
#include <LocalBoost/boost/predef/compiler/visualc.h>
#include <LocalBoost/boost/dll/detail/aggressive_ptr_cast.hpp>
#if BOOST_OS_WINDOWS
#   include <LocalBoost/boost/winapi/dll.hpp>
#   include <LocalBoost/boost/dll/detail/windows/path_from_handle.hpp>
#else
#   include <dlfcn.h>
#   include <LocalBoost/boost/dll/detail/posix/program_location_impl.hpp>
#endif
