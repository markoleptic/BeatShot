...
#include <LocalBoost/boost/numeric/odeint/iterator/integrate/integrate_adaptive.hpp>

// for has_value_type trait
#include <LocalBoost/boost/numeric/odeint/algebra/detail/extract_value_type.hpp>
