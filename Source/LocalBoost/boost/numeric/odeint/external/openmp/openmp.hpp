...
#include <LocalBoost/boost/numeric/odeint/external/openmp/openmp_range_algebra.hpp>

// level 2: split range state
#include <LocalBoost/boost/numeric/odeint/external/openmp/openmp_state.hpp>
