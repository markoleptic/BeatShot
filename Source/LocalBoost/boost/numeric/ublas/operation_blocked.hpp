...
#include <LocalBoost/boost/numeric/ublas/detail/vector_assign.hpp> // indexing_vector_assign
#include <LocalBoost/boost/numeric/ublas/detail/matrix_assign.hpp> // indexing_matrix_assign
