...
#include <LocalBoost/boost/optional.hpp> // to store locale when needed

#include <LocalBoost/boost/format/format_fwd.hpp>
#include <LocalBoost/boost/format/internals_fwd.hpp>
#include <LocalBoost/boost/format/internals.hpp>
#include <LocalBoost/boost/format/alt_sstream.hpp>
