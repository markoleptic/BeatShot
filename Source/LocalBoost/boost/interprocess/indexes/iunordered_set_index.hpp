...
#include <LocalBoost/boost/interprocess/containers/vector.hpp>
#include <LocalBoost/boost/intrusive/unordered_set.hpp>
#include <LocalBoost/boost/intrusive/detail/minimal_pair_header.hpp>
#include <LocalBoost/boost/intrusive/detail/minimal_less_equal_header.hpp>   //std::less
#include <LocalBoost/boost/container/detail/minimal_char_traits_header.hpp>  //std::char_traits
