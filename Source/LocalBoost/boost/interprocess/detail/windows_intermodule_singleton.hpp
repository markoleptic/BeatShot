...
#include <LocalBoost/boost/container/string.hpp>
...
#include <LocalBoost/boost/interprocess/sync/windows/winapi_semaphore_wrapper.hpp>
#include <LocalBoost/boost/interprocess/sync/windows/winapi_mutex_wrapper.hpp>
