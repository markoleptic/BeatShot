...
#include <LocalBoost/boost/interprocess/containers/flat_map.hpp>
#include <LocalBoost/boost/interprocess/containers/vector.hpp>   //vector
#include <LocalBoost/boost/interprocess/containers/set.hpp>      //set
// interprocess/detail
...
#include <LocalBoost/boost/interprocess/detail/cast_tags.hpp>
#include <LocalBoost/boost/interprocess/detail/mpl.hpp>
// other boost
#include <LocalBoost/boost/core/no_exceptions_support.hpp>
#include <LocalBoost/boost/static_assert.hpp>  //BOOST_STATIC_ASSERT
#include <LocalBoost/boost/integer/static_log2.hpp>
