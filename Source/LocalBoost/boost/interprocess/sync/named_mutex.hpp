...
#include <LocalBoost/boost/interprocess/permissions.hpp>
   ...
   #include <LocalBoost/boost/interprocess/sync/posix/named_mutex.hpp>
   #define BOOST_INTERPROCESS_NAMED_MUTEX_USE_POSIX
#elif !defined(BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION) && defined (BOOST_INTERPROCESS_WINDOWS)
   #include <LocalBoost/boost/interprocess/sync/windows/named_mutex.hpp>
   #define BOOST_INTERPROCESS_NAMED_MUTEX_USE_WINAPI
#else
   #include <LocalBoost/boost/interprocess/sync/shm/named_mutex.hpp>
#endif
