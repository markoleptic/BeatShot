...
#include <LocalBoost/boost/interprocess/sync/cv_status.hpp>
...
#include <LocalBoost/boost/interprocess/sync/shm/named_creation_functor.hpp>
#include <LocalBoost/boost/interprocess/sync/named_mutex.hpp>
#include <LocalBoost/boost/interprocess/permissions.hpp>
   ...
   #include <LocalBoost/boost/interprocess/sync/detail/condition_any_algorithm.hpp>
#else
   #include <LocalBoost/boost/interprocess/sync/detail/locks.hpp>
#endif
