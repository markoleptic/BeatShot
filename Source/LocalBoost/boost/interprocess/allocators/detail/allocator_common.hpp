...
#include <LocalBoost/boost/interprocess/detail/utilities.hpp> //to_raw_pointer
#include <LocalBoost/boost/utility/addressof.hpp> //boost::addressof
#include <LocalBoost/boost/assert.hpp>   //BOOST_ASSERT
#include <LocalBoost/boost/interprocess/exceptions.hpp> //bad_alloc
#include <LocalBoost/boost/interprocess/sync/scoped_lock.hpp> //scoped_lock
#include <LocalBoost/boost/interprocess/containers/allocation_type.hpp> //boost::interprocess::allocation_type
