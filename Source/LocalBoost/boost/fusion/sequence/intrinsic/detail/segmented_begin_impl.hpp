...
#include <LocalBoost/boost/fusion/sequence/intrinsic/detail/segmented_end_impl.hpp>
#include <LocalBoost/boost/fusion/support/detail/segmented_fold_until_impl.hpp>
