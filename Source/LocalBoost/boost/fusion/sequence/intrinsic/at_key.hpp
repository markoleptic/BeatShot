...
#include <LocalBoost/boost/fusion/sequence/intrinsic/has_key.hpp>
#include <LocalBoost/boost/fusion/algorithm/query/find.hpp>
#include <LocalBoost/boost/fusion/iterator/deref_data.hpp>
...
#include <LocalBoost/boost/mpl/empty_base.hpp>
