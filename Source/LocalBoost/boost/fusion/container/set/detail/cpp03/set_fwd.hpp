...
#include <LocalBoost/boost/fusion/container/set/detail/cpp03/limits.hpp>
#include <LocalBoost/boost/preprocessor/repetition/enum_params_with_a_default.hpp>

#if !defined(BOOST_FUSION_DONT_USE_PREPROCESSED_FILES)
#include <LocalBoost/boost/fusion/container/set/detail/cpp03/preprocessed/set_fwd.hpp>
#else
