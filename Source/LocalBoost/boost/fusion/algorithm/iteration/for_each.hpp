...
#include <LocalBoost/boost/fusion/algorithm/iteration/detail/for_each.hpp>
#include <LocalBoost/boost/fusion/algorithm/iteration/detail/segmented_for_each.hpp>
