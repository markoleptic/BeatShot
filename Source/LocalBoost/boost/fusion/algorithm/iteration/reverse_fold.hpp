...
#include <LocalBoost/boost/fusion/algorithm/iteration/reverse_fold_fwd.hpp>
...
#include <LocalBoost/boost/fusion/algorithm/iteration/detail/preprocessed/reverse_fold.hpp>
#else
