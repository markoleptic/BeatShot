...
#include <LocalBoost/boost/uuid/entropy_error.hpp>
#include <climits>
#include <iterator>
...
#include <LocalBoost/boost/uuid/detail/random_provider_detect_platform.hpp>
#include <LocalBoost/boost/uuid/detail/random_provider_include_platform.hpp>
