...
#include <LocalBoost/boost/iostreams/detail/config/codecvt.hpp> // mbstate_t.
#include <LocalBoost/boost/iostreams/detail/config/fpos.hpp>
#include <LocalBoost/boost/iostreams/detail/ios.hpp> // streamoff, streampos.
