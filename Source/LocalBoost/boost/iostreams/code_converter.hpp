...
#include <LocalBoost/boost/iostreams/detail/config/wide_streams.hpp>
...
#include <exception>
#include <LocalBoost/boost/config.hpp>                // DEDUCED_TYPENAME, 
#include <LocalBoost/boost/iostreams/char_traits.hpp>
#include <LocalBoost/boost/iostreams/constants.hpp>   // default_filter_buffer_size.
#include <LocalBoost/boost/iostreams/detail/adapter/concept_adapter.hpp>
#include <LocalBoost/boost/iostreams/detail/adapter/direct_adapter.hpp>
#include <LocalBoost/boost/iostreams/detail/buffer.hpp>
#include <LocalBoost/boost/iostreams/detail/call_traits.hpp>
#include <LocalBoost/boost/iostreams/detail/codecvt_holder.hpp>
#include <LocalBoost/boost/iostreams/detail/codecvt_helper.hpp>
#include <LocalBoost/boost/iostreams/detail/double_object.hpp>
#include <LocalBoost/boost/iostreams/detail/execute.hpp>
#include <LocalBoost/boost/iostreams/detail/forward.hpp>
#include <LocalBoost/boost/iostreams/detail/functional.hpp>
#include <LocalBoost/boost/iostreams/detail/ios.hpp> // failure, openmode, int types, streamsize.
#include <LocalBoost/boost/iostreams/detail/optional.hpp>
#include <LocalBoost/boost/iostreams/detail/select.hpp>
#include <LocalBoost/boost/iostreams/traits.hpp>
#include <LocalBoost/boost/iostreams/operations.hpp>
...
// Must come last.
#include <LocalBoost/boost/iostreams/detail/config/disable_warnings.hpp> // Borland 5.x
...
#include <LocalBoost/boost/iostreams/detail/config/enable_warnings.hpp> // Borland 5.x
