...
#include <LocalBoost/boost/config.hpp>                   // make sure size_t is in std.
#include <cstddef>                            // size_t.
#include <string>                             // pathnames.
#include <utility>                            // pair.
#include <LocalBoost/boost/config.hpp>                   // BOOST_MSVC.
#include <LocalBoost/boost/detail/workaround.hpp>
#include <LocalBoost/boost/iostreams/close.hpp>
#include <LocalBoost/boost/iostreams/concepts.hpp>
#include <LocalBoost/boost/iostreams/detail/config/auto_link.hpp>
#include <LocalBoost/boost/iostreams/detail/config/dyn_link.hpp>
#include <LocalBoost/boost/iostreams/detail/config/wide_streams.hpp>
#include <LocalBoost/boost/iostreams/detail/ios.hpp>     // openmode, failure
#include <LocalBoost/boost/iostreams/detail/path.hpp>
#include <LocalBoost/boost/iostreams/operations_fwd.hpp>
...
#include <LocalBoost/boost/config/abi_suffix.hpp> // pops abi_suffix.hpp pragmas
#if defined(BOOST_MSVC)
