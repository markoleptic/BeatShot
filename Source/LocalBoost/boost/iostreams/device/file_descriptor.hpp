...
#include <LocalBoost/boost/iostreams/categories.hpp>  // tags.
...
#include <LocalBoost/boost/iostreams/detail/config/windows_posix.hpp>
#include <LocalBoost/boost/iostreams/detail/file_handle.hpp>
