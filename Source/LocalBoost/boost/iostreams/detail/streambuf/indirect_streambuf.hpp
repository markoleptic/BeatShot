...
#include <cassert>
#include <exception>
#include <LocalBoost/boost/config.hpp>                      // Member template friends.
#include <LocalBoost/boost/detail/workaround.hpp>
#include <LocalBoost/boost/core/typeinfo.hpp>
#include <LocalBoost/boost/iostreams/constants.hpp>
...
#include <LocalBoost/boost/iostreams/detail/ios.hpp>
#include <LocalBoost/boost/iostreams/detail/optional.hpp>
#include <LocalBoost/boost/iostreams/detail/push.hpp>
#include <LocalBoost/boost/iostreams/detail/streambuf/linked_streambuf.hpp>
#include <LocalBoost/boost/iostreams/operations.hpp>
#include <LocalBoost/boost/iostreams/positioning.hpp>
...
// Must come last.
#include <LocalBoost/boost/iostreams/detail/config/disable_warnings.hpp>  // MSVC, BCC 5.x
...
#include <LocalBoost/boost/iostreams/detail/config/enable_warnings.hpp> // MSVC, BCC 5.x
