...
#include <LocalBoost/boost/checked_delete.hpp>
#include <LocalBoost/boost/config.hpp>                     // BOOST_MSVC, template friends,
#include <LocalBoost/boost/detail/workaround.hpp>          // BOOST_NESTED_TEMPLATE 
#include <LocalBoost/boost/core/typeinfo.hpp>
#include <LocalBoost/boost/iostreams/constants.hpp>
#include <LocalBoost/boost/iostreams/detail/access_control.hpp>
...
#include <LocalBoost/boost/iostreams/traits.hpp>           // is_filter.
#include <LocalBoost/boost/iostreams/stream_buffer.hpp>
