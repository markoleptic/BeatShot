...
#include <LocalBoost/boost/config.hpp>                // BOOST_STATIC_CONSTANT.
#include <LocalBoost/boost/iostreams/categories.hpp>
#include <LocalBoost/boost/iostreams/detail/char_traits.hpp>
#include <LocalBoost/boost/iostreams/detail/ios.hpp>  // BOOST_IOSTREAMS_FAILURE 
#include <LocalBoost/boost/iostreams/read.hpp>        // get 
#include <LocalBoost/boost/iostreams/write.hpp>       // put 
