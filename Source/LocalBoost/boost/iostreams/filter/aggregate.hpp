...
#include <vector>
#include <LocalBoost/boost/iostreams/constants.hpp>      // default_device_buffer_size 
#include <LocalBoost/boost/iostreams/categories.hpp>
#include <LocalBoost/boost/iostreams/detail/char_traits.hpp>
#include <LocalBoost/boost/iostreams/detail/ios.hpp>     // openmode, streamsize.
#include <LocalBoost/boost/iostreams/pipeline.hpp>
#include <LocalBoost/boost/iostreams/read.hpp>           // check_eof 
