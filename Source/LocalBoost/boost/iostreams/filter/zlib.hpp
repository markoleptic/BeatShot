...
#include <new>          
#include <LocalBoost/boost/config.hpp>  // MSVC, STATIC_CONSTANT, DEDUCED_TYPENAME, DINKUM.
#include <LocalBoost/boost/cstdint.hpp> // uint*_t
...
#include <LocalBoost/boost/iostreams/detail/config/zlib.hpp>
#include <LocalBoost/boost/iostreams/detail/ios.hpp>  // failure, streamsize.
#include <LocalBoost/boost/iostreams/filter/symmetric.hpp>                
