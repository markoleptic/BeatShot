...
#include <LocalBoost/boost/regex/v4/iterator_category.hpp>
...
//
#ifdef BOOST_REGEX_RECURSIVE
#include <LocalBoost/boost/regex/v4/perl_matcher_recursive.hpp>
#else
#include <LocalBoost/boost/regex/v4/perl_matcher_non_recursive.hpp>
#endif
// this one has to be last:
#include <LocalBoost/boost/regex/v4/perl_matcher_common.hpp>
