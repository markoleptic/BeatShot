...
#include <LocalBoost/boost/regex/v5/syntax_type.hpp>
#include <LocalBoost/boost/regex/v5/error_type.hpp>
#include <LocalBoost/boost/regex/v5/regex_traits_defaults.hpp>
#include <LocalBoost/boost/regex/v5/cpp_regex_traits.hpp>
#include <LocalBoost/boost/regex/v5/c_regex_traits.hpp>
#if defined(_WIN32) && !defined(BOOST_REGEX_NO_W32)
#     include <LocalBoost/boost/regex/v5/w32_regex_traits.hpp>
#endif
