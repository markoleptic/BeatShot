...
#include <LocalBoost/boost/config.hpp> // Member template friends, put size_t in std.
#include <cstddef>          // size_t
#include <LocalBoost/boost/compressed_pair.hpp> 
#include <LocalBoost/boost/ptr_container/detail/default_deleter.hpp>       
#include <LocalBoost/boost/ptr_container/detail/is_convertible.hpp>       
#include <LocalBoost/boost/ptr_container/detail/move.hpp>       
