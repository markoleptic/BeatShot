...
#include <LocalBoost/boost/log/detail/timestamp.hpp>
#include <LocalBoost/boost/log/detail/enqueued_record.hpp>
#include <LocalBoost/boost/log/keywords/order.hpp>
#include <LocalBoost/boost/log/keywords/ordering_window.hpp>
