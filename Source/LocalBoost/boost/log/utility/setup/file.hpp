...
#include <LocalBoost/boost/smart_ptr/make_shared_object.hpp>
#include <LocalBoost/boost/parameter/parameters.hpp> // for is_named_argument
...
#include <LocalBoost/boost/log/detail/sink_init_helpers.hpp>
#include <LocalBoost/boost/log/detail/parameter_tools.hpp>
#include <LocalBoost/boost/log/core/core.hpp>
#ifndef BOOST_LOG_NO_THREADS
#include <LocalBoost/boost/log/sinks/sync_frontend.hpp>
#else
#include <LocalBoost/boost/log/sinks/unlocked_frontend.hpp>
#endif
#include <LocalBoost/boost/log/sinks/text_file_backend.hpp>
#include <LocalBoost/boost/log/keywords/format.hpp>
#include <LocalBoost/boost/log/keywords/filter.hpp>
#include <LocalBoost/boost/log/keywords/scan_method.hpp>
