...
#include <LocalBoost/boost/mpl/size_fwd.hpp>
#include <LocalBoost/boost/mpl/empty_fwd.hpp>
#include <LocalBoost/boost/mpl/front_fwd.hpp>
#include <LocalBoost/boost/mpl/back_fwd.hpp>
#include <LocalBoost/boost/mpl/at_fwd.hpp>
#include <LocalBoost/boost/mpl/begin_end_fwd.hpp>
#include <LocalBoost/boost/mpl/clear_fwd.hpp>
#include <LocalBoost/boost/mpl/push_front_fwd.hpp>
#include <LocalBoost/boost/mpl/pop_front_fwd.hpp>
#include <LocalBoost/boost/mpl/push_back_fwd.hpp>
#include <LocalBoost/boost/mpl/pop_back_fwd.hpp>
