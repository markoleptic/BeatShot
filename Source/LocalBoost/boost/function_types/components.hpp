...
#include <LocalBoost/boost/mpl/integral_c.hpp>
#include <LocalBoost/boost/mpl/vector/vector0.hpp>
...
#   include <LocalBoost/boost/mpl/bitand.hpp>
#   include <LocalBoost/boost/mpl/vector/vector10.hpp>
#   include <LocalBoost/boost/mpl/front.hpp>
#   include <LocalBoost/boost/mpl/begin.hpp>
#   include <LocalBoost/boost/mpl/advance.hpp>
#   include <LocalBoost/boost/mpl/iterator_range.hpp>
#   include <LocalBoost/boost/mpl/joint_view.hpp>
#   include <LocalBoost/boost/mpl/equal_to.hpp>
#   include <LocalBoost/boost/mpl/copy.hpp>
#   include <LocalBoost/boost/mpl/front_inserter.hpp>

#   include <LocalBoost/boost/function_types/detail/classifier.hpp>
#endif

#ifndef BOOST_FT_NO_CV_FUNC_SUPPORT
#   include <LocalBoost/boost/mpl/remove.hpp>
#endif

#include <LocalBoost/boost/function_types/config/config.hpp>

#   if   BOOST_FT_MAX_ARITY < 10
#     include <LocalBoost/boost/mpl/vector/vector10.hpp>
#   elif BOOST_FT_MAX_ARITY < 20
#     include <LocalBoost/boost/mpl/vector/vector20.hpp>
#   elif BOOST_FT_MAX_ARITY < 30
#     include <LocalBoost/boost/mpl/vector/vector30.hpp>
#   elif BOOST_FT_MAX_ARITY < 40
#     include <LocalBoost/boost/mpl/vector/vector40.hpp>
#   elif BOOST_FT_MAX_ARITY < 50
#     include <LocalBoost/boost/mpl/vector/vector50.hpp>
#   endif

#include <LocalBoost/boost/function_types/detail/class_transform.hpp>
...
#include <LocalBoost/boost/function_types/detail/pp_loop.hpp>

  } } // namespace function_types::detail

} // namespace ::boost

#include <LocalBoost/boost/function_types/detail/components_as_mpl_sequence.hpp>
#include <LocalBoost/boost/function_types/detail/retag_default_cc.hpp>
