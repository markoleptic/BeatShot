...
#include <LocalBoost/boost/type_traits/detail/common_arithmetic_type.hpp>
#include <LocalBoost/boost/type_traits/detail/composite_pointer_type.hpp>
#include <LocalBoost/boost/type_traits/detail/composite_member_pointer_type.hpp>
