...
#include <LocalBoost/boost/filesystem/file_status.hpp>
#include <LocalBoost/boost/filesystem/detail/path_traits.hpp>
...
#include <LocalBoost/boost/core/scoped_enum.hpp>
#include <LocalBoost/boost/detail/bitmask.hpp>
#include <LocalBoost/boost/system/error_code.hpp>
#include <LocalBoost/boost/smart_ptr/intrusive_ptr.hpp>
#include <LocalBoost/boost/smart_ptr/intrusive_ref_counter.hpp>
#include <LocalBoost/boost/iterator/iterator_facade.hpp>
#include <LocalBoost/boost/iterator/iterator_categories.hpp>

#include <LocalBoost/boost/filesystem/detail/header.hpp> // must be the last #include
