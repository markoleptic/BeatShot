...
#include <LocalBoost/boost/qvm/vec_mat_operations2.hpp>
#include <LocalBoost/boost/qvm/vec_mat_operations3.hpp>
#include <LocalBoost/boost/qvm/vec_mat_operations4.hpp>
