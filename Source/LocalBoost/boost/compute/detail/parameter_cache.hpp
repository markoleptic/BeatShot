...
#include <LocalBoost/boost/compute/detail/global_static.hpp>
#include <LocalBoost/boost/compute/version.hpp>

#ifdef BOOST_COMPUTE_USE_OFFLINE_CACHE
#include <cstdio>  
#include <LocalBoost/boost/algorithm/string/trim.hpp>
#include <LocalBoost/boost/compute/detail/path.hpp>
#include <LocalBoost/boost/property_tree/ptree.hpp>
#include <LocalBoost/boost/property_tree/json_parser.hpp>
