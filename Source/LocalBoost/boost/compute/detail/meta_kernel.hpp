...
#include <LocalBoost/boost/algorithm/string/find.hpp>
#include <LocalBoost/boost/preprocessor/repetition.hpp>

#include <LocalBoost/boost/compute/kernel.hpp>
#include <LocalBoost/boost/compute/closure.hpp>
#include <LocalBoost/boost/compute/function.hpp>
#include <LocalBoost/boost/compute/functional.hpp>
#include <LocalBoost/boost/compute/type_traits.hpp>
#include <LocalBoost/boost/compute/command_queue.hpp>
#include <LocalBoost/boost/compute/image/image2d.hpp>
#include <LocalBoost/boost/compute/image/image_sampler.hpp>
#include <LocalBoost/boost/compute/memory_object.hpp>
#include <LocalBoost/boost/compute/memory/svm_ptr.hpp>
#include <LocalBoost/boost/compute/detail/device_ptr.hpp>
#include <LocalBoost/boost/compute/detail/sha1.hpp>
#include <LocalBoost/boost/compute/utility/program_cache.hpp>
