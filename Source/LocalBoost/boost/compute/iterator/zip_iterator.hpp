...
#include <LocalBoost/boost/tuple/tuple_comparison.hpp>
...
#include <LocalBoost/boost/compute/detail/mpl_vector_to_tuple.hpp>
#include <LocalBoost/boost/compute/types/tuple.hpp>
