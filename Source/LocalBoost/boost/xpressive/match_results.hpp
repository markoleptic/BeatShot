...
#include <LocalBoost/boost/intrusive_ptr.hpp>
#include <LocalBoost/boost/throw_exception.hpp>
#include <LocalBoost/boost/iterator_adaptors.hpp>
#include <LocalBoost/boost/utility/enable_if.hpp>
#include <LocalBoost/boost/detail/workaround.hpp>
#include <LocalBoost/boost/numeric/conversion/converter.hpp>
#include <LocalBoost/boost/optional.hpp>
#include <LocalBoost/boost/range/end.hpp>
#include <LocalBoost/boost/range/begin.hpp>
#include <LocalBoost/boost/range/as_literal.hpp>
#include <LocalBoost/boost/range/const_iterator.hpp>
#include <LocalBoost/boost/type_traits/is_function.hpp>
#if BOOST_ITERATOR_ADAPTORS_VERSION >= 0x0200
# include <LocalBoost/boost/iterator/filter_iterator.hpp>
#endif
#include <LocalBoost/boost/xpressive/regex_constants.hpp>
#include <LocalBoost/boost/xpressive/detail/detail_fwd.hpp>
#include <LocalBoost/boost/xpressive/detail/core/regex_impl.hpp>
#include <LocalBoost/boost/xpressive/detail/core/sub_match_vector.hpp>
#include <LocalBoost/boost/xpressive/detail/utility/sequence_stack.hpp>
#include <LocalBoost/boost/xpressive/detail/core/results_cache.hpp>
#include <LocalBoost/boost/xpressive/detail/utility/literals.hpp>
#include <LocalBoost/boost/xpressive/detail/utility/algorithm.hpp>
#include <LocalBoost/boost/xpressive/detail/utility/counted_base.hpp>
