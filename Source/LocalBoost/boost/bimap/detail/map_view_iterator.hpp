...
#include <LocalBoost/boost/bimap/relation/support/pair_by.hpp>

// check
#include <LocalBoost/boost/bimap/relation/detail/metadata_access_builder.hpp>
#include <LocalBoost/boost/bimap/relation/detail/static_access_builder.hpp>
