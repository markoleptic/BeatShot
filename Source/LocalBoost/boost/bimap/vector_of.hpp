...
#include <LocalBoost/boost/multi_index/random_access_index.hpp>

#include <LocalBoost/boost/bimap/views/vector_map_view.hpp>
#include <LocalBoost/boost/bimap/views/vector_set_view.hpp>
