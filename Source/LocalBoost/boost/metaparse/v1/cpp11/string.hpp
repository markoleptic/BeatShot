...
#include <LocalBoost/boost/metaparse/v1/cpp11/impl/empty_string.hpp>
#include <LocalBoost/boost/metaparse/v1/cpp11/impl/size.hpp>
#include <LocalBoost/boost/metaparse/v1/cpp11/impl/pop_front.hpp>
#include <LocalBoost/boost/metaparse/v1/cpp11/impl/push_front_c.hpp>
#include <LocalBoost/boost/metaparse/v1/cpp11/impl/push_back_c.hpp>
#include <LocalBoost/boost/metaparse/v1/cpp11/impl/pop_back.hpp>
#include <LocalBoost/boost/metaparse/v1/cpp11/impl/string_at.hpp>
...
#  else
#    include <LocalBoost/boost/metaparse/v1/cpp11/impl/string.hpp>
#  endif
#else
#  include <LocalBoost/boost/metaparse/v1/cpp11/impl/string.hpp>
#endif
