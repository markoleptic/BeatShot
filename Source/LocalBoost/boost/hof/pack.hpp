...
#include <LocalBoost/boost/hof/detail/remove_rvalue_reference.hpp>
#include <LocalBoost/boost/hof/detail/unwrap.hpp>
...
#include <LocalBoost/boost/hof/alias.hpp>
#include <LocalBoost/boost/hof/decay.hpp>
