...
#include <LocalBoost/boost/serialization/force_include.hpp>
#include <LocalBoost/boost/serialization/type_info_implementation.hpp>
#include <LocalBoost/boost/serialization/extended_type_info.hpp>
#include <LocalBoost/boost/type_traits/is_virtual_base_of.hpp>
#include <LocalBoost/boost/type_traits/aligned_storage.hpp>
#include <LocalBoost/boost/serialization/void_cast_fwd.hpp>

#include <LocalBoost/boost/serialization/config.hpp>
#include <LocalBoost/boost/config/abi_prefix.hpp> // must be the last header
