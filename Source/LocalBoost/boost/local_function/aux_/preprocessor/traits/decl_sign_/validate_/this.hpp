...
#include <LocalBoost/boost/local_function/detail/preprocessor/keyword/this.hpp>
#include <LocalBoost/boost/local_function/detail/preprocessor/keyword/const.hpp>
