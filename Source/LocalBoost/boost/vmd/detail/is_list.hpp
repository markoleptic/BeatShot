...
#include <LocalBoost/boost/preprocessor/debug/assert.hpp>
...
#include <LocalBoost/boost/vmd/is_tuple.hpp>
#include <LocalBoost/boost/vmd/detail/nil_registration.hpp>
