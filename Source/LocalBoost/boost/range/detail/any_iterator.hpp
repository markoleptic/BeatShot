...
#include <LocalBoost/boost/range/detail/any_iterator_buffer.hpp>
#include <LocalBoost/boost/range/detail/any_iterator_interface.hpp>
#include <LocalBoost/boost/range/detail/any_iterator_wrapper.hpp>
