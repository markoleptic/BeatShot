...
#include <LocalBoost/boost/stl_interfaces/config.hpp>
#include <LocalBoost/boost/stl_interfaces/detail/view_closure.hpp>

#include <LocalBoost/boost/type_traits/is_detected.hpp>
