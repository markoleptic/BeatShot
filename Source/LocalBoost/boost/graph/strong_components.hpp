...
#include <LocalBoost/boost/type_traits/conversion_traits.hpp>
...
#include <queue>
#include <vector>
#include <LocalBoost/boost/graph/transpose_graph.hpp>
#include <LocalBoost/boost/pending/indirect_cmp.hpp>
#include <LocalBoost/boost/graph/connected_components.hpp> // for components_recorder
