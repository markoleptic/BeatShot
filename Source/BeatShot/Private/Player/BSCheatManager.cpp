...
{
	static TAutoConsoleVariable CVarCheat_AimBot(TEXT("bs_cheat.aimbot"),
		FString(),
		TEXT("Enable Aim Bot \n"
	...
	static TAutoConsoleVariable CVarPrintDebug_GetMaxIndex(TEXT("bs_printdebug.getmaxindex"),
		0,
		TEXT("Toggles printing the Reinforcement Learning Component's intermediate values when finding the max action index."));

	
	static TAutoConsoleVariable CVarPrintDebug_QTableUpdate(TEXT("bs_printdebug.qtableupdate"),
		0,
		TEXT("Toggles printing the old and new QTable value each time the Reinforcement Learning Component makes an update to the QTable."));
	...
	static TAutoConsoleVariable CVarShowDebug_AllSpawnAreas(TEXT("bs_showdebug.allspawnareas"),
		0,
		TEXT("Toggles showing Cyan debug boxes for all Spawn Areas at the end of the GetValidSpawnLocations function. Persistant boxes."));
	

	static TAutoConsoleVariable CVarShowDebug_ValidSpawnAreas(TEXT("bs_showdebug.validspawnareas"),
		0,
		TEXT("Toggles showing Green debug boxes for valid Spawn Areas at the end of the GetValidSpawnLocations function."));
	...
	static TAutoConsoleVariable CVarShowDebug_FilteredRecent(TEXT("bs_showdebug.filteredrecent"),
		0,
		TEXT("Toggles showing Turquoise debug boxes for filtered recent Spawn Areas at the end of the FilterRecentIndices function."));

	
	static TAutoConsoleVariable CVarShowDebug_FilteredActivated(TEXT("bs_showdebug.filteredactivated"),
		0,
		TEXT("Toggles showing Cyan debug boxes for filtered activated Spawn Areas at the end of the FilterActivatedIndices function."));

	
	static TAutoConsoleVariable CVarShowDebug_FilteredManaged(TEXT("bs_showdebug.filtermanaged"),
		0,
		TEXT("Toggles showing Blue debug boxes for filtered managed Spawn Areas at the end of the FilterManagedIndices function."));
	...
	static TAutoConsoleVariable CVarShowDebug_OverlappingVertices_OnFlaggedManaged(TEXT("bs_showdebug.overlappingverts_onmanaged"),
		0,
...
void UBSCheatManager::InitCheatManager()
{
	...
	CVarPrintDebugNumRecentNumActiveDelegate.BindUObject(this, &UBSCheatManager::CVarOnChanged_PrintDebug_NumRecentNumActive);
	BeatShotConsoleVariables::CVarPrintDebug_NumRecentNumActive.AsVariable()->SetOnChangedCallback(CVarPrintDebugNumRecentNumActiveDelegate);

	FConsoleVariableDelegate CVarPrintDebugChooseBestActionIndexDelegate;
	CVarPrintDebugChooseBestActionIndexDelegate.BindUObject(this, &UBSCheatManager::CVarOnChanged_PrintDebug_ChooseBestActionIndex);
	BeatShotConsoleVariables::CVarPrintDebug_ChooseBestActionIndex.AsVariable()->SetOnChangedCallback(CVarPrintDebugChooseBestActionIndexDelegate);
	...
	BeatShotConsoleVariables::CVarPrintDebug_GetMaxIndex.AsVariable()->SetOnChangedCallback(CVarPrintDebugGetMaxIndexDelegate);
	...
	BeatShotConsoleVariables::CVarPrintDebug_QTableUpdate.AsVariable()->SetOnChangedCallback(CVarPrintDebugQTableUpdateDelegate);
	
	FConsoleVariableDelegate CVarShowDebugReinforcementLearningWidgetDelegate;
	CVarShowDebugReinforcementLearningWidgetDelegate.BindUObject(this, &UBSCheatManager::CVarOnChanged_ShowDebug_ReinforcementLearningWidget);
	BeatShotConsoleVariables::CVarShowDebug_ReinforcementLearningWidget.AsVariable()->SetOnChangedCallback(CVarShowDebugReinforcementLearningWidgetDelegate);
	...
	BeatShotConsoleVariables::CVarShowDebug_AllSpawnAreas.AsVariable()->SetOnChangedCallback(CVarShowDebugAllSpawnAreas);
	...
	BeatShotConsoleVariables::CVarShowDebug_ValidSpawnAreas.AsVariable()->SetOnChangedCallback(CVarShowDebugValidSpawnAreas);
	...
	BeatShotConsoleVariables::CVarShowDebug_RemovedSpawnAreas.AsVariable()->SetOnChangedCallback(CVarShowDebugRemovedSpawnAreas);
	...
	BeatShotConsoleVariables::CVarShowDebug_FilteredRecent.AsVariable()->SetOnChangedCallback(CVarShowDebugFilteredRecent);
	...
	BeatShotConsoleVariables::CVarShowDebug_FilteredActivated.AsVariable()->SetOnChangedCallback(CVarShowDebugFilteredActivated);
	...
	BeatShotConsoleVariables::CVarShowDebug_FilteredManaged.AsVariable()->SetOnChangedCallback(CVarShowDebugFilteredManaged);

	FConsoleVariableDelegate CVarShowDebugOverlappingVertices_Dynamic;
	CVarShowDebugOverlappingVertices_Dynamic.BindUObject(this, &UBSCheatManager::CVarOnChanged_ShowDebug_OverlappingVertices_Dynamic);
	BeatShotConsoleVariables::CVarShowDebug_OverlappingVertices_Dynamic.AsVariable()->SetOnChangedCallback(CVarShowDebugOverlappingVertices_Dynamic);

	FConsoleVariableDelegate CVarShowDebugOverlappingVertices_OnFlaggedManaged;
	CVarShowDebugOverlappingVertices_OnFlaggedManaged.BindUObject(this, &UBSCheatManager::CVarOnChanged_ShowDebug_OverlappingVertices_OnFlaggedManaged);
	BeatShotConsoleVariables::CVarShowDebug_OverlappingVertices_OnFlaggedManaged.AsVariable()->SetOnChangedCallback(CVarShowDebugOverlappingVertices_OnFlaggedManaged);
	...
	BeatShotConsoleVariables::CVarShowDebug_TargetManager.AsVariable()->SetOnChangedCallback(CVarShowDebugTargetManagerDelegate);
	...
	BeatShotConsoleVariables::CVarShowDebug_FrontSpotLight.AsVariable()->SetOnChangedCallback(CVarShowDebugSpotLightFront);
...
void UBSCheatManager::CVarOnChanged_ShowDebug_ReinforcementLearningWidget(IConsoleVariable* Variable)
{
	...
	if (bShowWidget)
	{
		if (bAvg)
		{
			Controller->ShowRLAgentWidget(TargetManager->ReinforcementLearningComponent->OnQTableUpdate,
			5, 5, TargetManager->ReinforcementLearningComponent->GetTArray_FromNdArray_QTableAvg());
		}
		else
		{
			Controller->ShowRLAgentWidget(TargetManager->ReinforcementLearningComponent->OnQTableUpdate,
			5, 5, TargetManager->ReinforcementLearningComponent->GetTArray_FromNdArray_QTableMax());
		}
	}
	else
	{
