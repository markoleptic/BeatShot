...
void FBSGameplayTags::InitializeNativeTags()
{
...
FGameplayTag FBSGameplayTags::FindTagByString(FString TagString, bool bMatchPartialString)
{
...
void FBSGameplayTags::AddAllTags(UGameplayTagsManager& Manager)
{
	...
	AddTag(InputTag_Look, "InputTag.Look.Mouse", "Look (mouse) input.");
	AddTag(InputTag_Crouch, "InputTag.Crouch", "Crouch input.");
	AddTag(InputTag_Sprint, "InputTag.Sprint", "Sprint.");
...
void FBSGameplayTags::AddMovementModeTag(FGameplayTag& OutTag, const ANSICHAR* TagName, uint8 MovementMode)
{
	AddTag(OutTag, TagName, "Character movement mode tag.");
	GameplayTags.MovementModeTagMap.Add(MovementMode, OutTag);
}

void FBSGameplayTags::AddCustomMovementModeTag(FGameplayTag& OutTag, const ANSICHAR* TagName, uint8 CustomMovementMode)
{
