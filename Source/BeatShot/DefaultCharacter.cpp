...
void ADefaultCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//PlayerInputComponent->BindAction(TEXT("Fire"), IE_Repeat, this, &ADefaultCharacter::Fire);
	...
	if (UEnhancedInputComponent* PlayerEnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		{
			// Crouching
			PlayerEnhancedInputComponent->BindAction(CrouchAction, ETriggerEvent::Started, this, &ADefaultCharacter::ToggleCrouch);
...
void ADefaultCharacter::StopCrouch(const bool bToSprint)
{
...
{
	//if (MovementState == EMovementState::State_Crouch || MovementState ==
