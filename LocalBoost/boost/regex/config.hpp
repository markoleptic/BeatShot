...
#  include <LocalBoost/boost/regex/config/borland.hpp>
#endif
...
#  include <LocalBoost/boost/predef.h>
   ...
   /*
    * C build,
    * don't include <LocalBoost/boost/config.hpp> because that may
...
#  include <LocalBoost/boost/regex/config/cwchar.hpp>
#endif
