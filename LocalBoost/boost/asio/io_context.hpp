...
#include <LocalBoost/boost/asio/detail/concurrency_hint.hpp>
#include <LocalBoost/boost/asio/detail/cstdint.hpp>
#include <LocalBoost/boost/asio/detail/wrapped_handler.hpp>
#include <LocalBoost/boost/system/error_code.hpp>
...
# include <LocalBoost/boost/asio/detail/chrono.hpp>
#endif // defined(BOOST_ASIO_HAS_CHRONO)

#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
# include <LocalBoost/boost/asio/detail/winsock_init.hpp>
#elif defined(__sun) || defined(__QNX__) || defined(__hpux) || defined(_AIX) \
  || defined(__osf__)
# include <LocalBoost/boost/asio/detail/signal_init.hpp>
#endif
...
#include <LocalBoost/boost/asio/impl/io_context.hpp>
