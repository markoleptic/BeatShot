...
# include <LocalBoost/boost/asio/detail/win_iocp_handle_service.hpp>
#elif defined(BOOST_ASIO_HAS_IO_URING_AS_DEFAULT)
# include <LocalBoost/boost/asio/detail/io_uring_descriptor_service.hpp>
#else
# include <LocalBoost/boost/asio/detail/reactive_descriptor_service.hpp>
#endif
