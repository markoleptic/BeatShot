...
#include <LocalBoost/boost/asio/traits/require_concept_member.hpp>
#include <LocalBoost/boost/asio/traits/require_concept_free.hpp>
#include <LocalBoost/boost/asio/traits/static_require_concept.hpp>
