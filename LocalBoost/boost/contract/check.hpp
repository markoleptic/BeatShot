...
#include <LocalBoost/boost/contract/core/exception.hpp> // For set_... (if always in code).
#if !defined(BOOST_CONTRACT_NO_CONDITIONS) || \
        defined(BOOST_CONTRACT_STATIC_LINK)
    #include <LocalBoost/boost/contract/detail/condition/cond_base.hpp>
    #include <LocalBoost/boost/contract/detail/auto_ptr.hpp>
    #include <LocalBoost/boost/contract/detail/debug.hpp>
#endif
#include <LocalBoost/boost/contract/detail/check.hpp>
