...
#        include <LocalBoost/boost/preprocessor/iteration/detail/start.hpp>
#        define BOOST_PP_VALUE BOOST_PP_TUPLE_ELEM(2, 1, BOOST_PP_LOCAL_LIMITS)
#        include <LocalBoost/boost/preprocessor/iteration/detail/finish.hpp>
...
#    include <LocalBoost/boost/preprocessor/iteration/detail/rlocal.hpp>
# else
#
...
#    include <LocalBoost/boost/preprocessor/iteration/detail/limits/local_256.hpp>
#    elif BOOST_PP_LIMIT_ITERATION == 512
#    include <LocalBoost/boost/preprocessor/iteration/detail/limits/local_256.hpp>
#    include <LocalBoost/boost/preprocessor/iteration/detail/limits/local_512.hpp>
#    elif BOOST_PP_LIMIT_ITERATION == 1024
#    include <LocalBoost/boost/preprocessor/iteration/detail/limits/local_256.hpp>
#    include <LocalBoost/boost/preprocessor/iteration/detail/limits/local_512.hpp>
#    include <LocalBoost/boost/preprocessor/iteration/detail/limits/local_1024.hpp>
#    else
