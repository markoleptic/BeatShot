...
#
# if BOOST_PP_CONFIG_FLAGS() & BOOST_PP_CONFIG_EDG()
#    include <LocalBoost/boost/preprocessor/control/detail/edg/while.hpp>
# elif BOOST_PP_CONFIG_FLAGS() & BOOST_PP_CONFIG_MSVC()
#    include <LocalBoost/boost/preprocessor/control/detail/msvc/while.hpp>
# elif BOOST_PP_CONFIG_FLAGS() & BOOST_PP_CONFIG_DMC()
#    include <LocalBoost/boost/preprocessor/control/detail/dmc/while.hpp>
# else
#    include <LocalBoost/boost/preprocessor/control/detail/while.hpp>
# endif
#
...
# include <LocalBoost/boost/preprocessor/list/fold_right.hpp>
# include <LocalBoost/boost/preprocessor/logical/bitand.hpp>
# include <LocalBoost/boost/preprocessor/config/limits.hpp>
#
# /* BOOST_PP_WHILE */
#
# if 0
...
#
# if BOOST_PP_LIMIT_WHILE == 256
# include <LocalBoost/boost/preprocessor/control/limits/while_256.hpp>
# elif BOOST_PP_LIMIT_WHILE == 512
# include <LocalBoost/boost/preprocessor/control/limits/while_256.hpp>
# include <LocalBoost/boost/preprocessor/control/limits/while_512.hpp>
# elif BOOST_PP_LIMIT_WHILE == 1024
# include <LocalBoost/boost/preprocessor/control/limits/while_256.hpp>
# include <LocalBoost/boost/preprocessor/control/limits/while_512.hpp>
# include <LocalBoost/boost/preprocessor/control/limits/while_1024.hpp>
# endif
#
# endif
#
