...
#include <LocalBoost/boost/smart_ptr/bad_weak_ptr.hpp>
#include <LocalBoost/boost/smart_ptr/detail/sp_counted_base.hpp>
#include <LocalBoost/boost/smart_ptr/detail/sp_counted_impl.hpp>
