...
#include <LocalBoost/boost/accumulators/framework/depends_on.hpp> // for feature_of
#include <LocalBoost/boost/accumulators/framework/parameters/accumulator.hpp> // for accumulator
