...
#include <LocalBoost/boost/preprocessor/array/data.hpp>
#include <LocalBoost/boost/preprocessor/array/elem.hpp>
#include <LocalBoost/boost/preprocessor/seq/to_array.hpp>
#include <LocalBoost/boost/preprocessor/seq/transform.hpp>
