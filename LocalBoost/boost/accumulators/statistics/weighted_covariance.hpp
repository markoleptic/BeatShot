...
#include <LocalBoost/boost/numeric/ublas/io.hpp>
#include <LocalBoost/boost/numeric/ublas/matrix.hpp>
...
#include <LocalBoost/boost/accumulators/statistics/covariance.hpp> // for numeric::outer_product() and type traits
