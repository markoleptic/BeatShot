...
#include <LocalBoost/boost/process/detail/handler_base.hpp>
#include <LocalBoost/boost/process/detail/traits/cmd_or_exe.hpp>
#include <LocalBoost/boost/process/detail/traits/wchar_t.hpp>

#if defined( BOOST_WINDOWS_API )
#include <LocalBoost/boost/process/detail/windows/basic_cmd.hpp>
#include <LocalBoost/boost/process/detail/windows/cmd.hpp>
#elif defined( BOOST_POSIX_API )
#include <LocalBoost/boost/process/detail/posix/basic_cmd.hpp>
#include <LocalBoost/boost/process/detail/posix/cmd.hpp>
#endif

#include <LocalBoost/boost/process/shell.hpp>
