...
#include <LocalBoost/boost/process/environment.hpp>
#include <LocalBoost/boost/none.hpp>

#if defined(BOOST_POSIX_API)
#include <LocalBoost/boost/process/detail/posix/env_init.hpp>
#elif defined(BOOST_WINDOWS_API)
#include <LocalBoost/boost/process/detail/windows/env_init.hpp>
#endif
