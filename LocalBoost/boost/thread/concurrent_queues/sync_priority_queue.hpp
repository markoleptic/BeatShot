...
#include <LocalBoost/boost/thread/concurrent_queues/detail/sync_queue_base.hpp>
...
#include <LocalBoost/boost/atomic.hpp>
#include <LocalBoost/boost/chrono/duration.hpp>
