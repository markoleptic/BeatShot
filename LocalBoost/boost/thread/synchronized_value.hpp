...
#include <LocalBoost/boost/thread/lock_factories.hpp>
#include <LocalBoost/boost/thread/strict_lock.hpp>
...
//#include <LocalBoost/boost/thread/detail/is_nothrow_default_constructible.hpp>
