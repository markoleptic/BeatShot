...
#include <LocalBoost/boost/thread/detail/config.hpp>
...
#include <LocalBoost/boost/thread/detail/move.hpp>
#include <LocalBoost/boost/thread/detail/invoker.hpp>
#include <LocalBoost/boost/thread/detail/invoke.hpp>
#include <LocalBoost/boost/thread/detail/is_convertible.hpp>
#include <LocalBoost/boost/thread/exceptional_ptr.hpp>
#include <LocalBoost/boost/thread/futures/future_error.hpp>
#include <LocalBoost/boost/thread/futures/future_error_code.hpp>
#include <LocalBoost/boost/thread/futures/future_status.hpp>
#include <LocalBoost/boost/thread/futures/is_future_type.hpp>
#include <LocalBoost/boost/thread/futures/launch.hpp>
#include <LocalBoost/boost/thread/futures/wait_for_all.hpp>
#include <LocalBoost/boost/thread/futures/wait_for_any.hpp>
#include <LocalBoost/boost/thread/lock_algorithms.hpp>
#include <LocalBoost/boost/thread/lock_types.hpp>
#include <LocalBoost/boost/thread/mutex.hpp>
#include <LocalBoost/boost/thread/thread_only.hpp>
#include <LocalBoost/boost/thread/thread_time.hpp>
#include <LocalBoost/boost/thread/executor.hpp>
#include <LocalBoost/boost/thread/executors/generic_executor_ref.hpp>

#if defined BOOST_THREAD_FUTURE_USES_OPTIONAL
#include <LocalBoost/boost/optional.hpp>
#else
#include <LocalBoost/boost/thread/csbl/memory/unique_ptr.hpp>
#endif

#include <LocalBoost/boost/assert.hpp>
#include <LocalBoost/boost/bind/bind.hpp>
#ifdef BOOST_THREAD_USES_CHRONO
#include <LocalBoost/boost/chrono/system_clocks.hpp>
#endif
#include <LocalBoost/boost/core/enable_if.hpp>
#include <LocalBoost/boost/core/ref.hpp>
#include <LocalBoost/boost/enable_shared_from_this.hpp>
#include <LocalBoost/boost/exception_ptr.hpp>
#include <LocalBoost/boost/function.hpp>
#include <LocalBoost/boost/next_prior.hpp>
#include <LocalBoost/boost/scoped_array.hpp>
#include <LocalBoost/boost/shared_ptr.hpp>
#include <LocalBoost/boost/smart_ptr/make_shared.hpp>
...
#include <LocalBoost/boost/thread/detail/memory.hpp>
#include <LocalBoost/boost/container/scoped_allocator.hpp>
...
#include <LocalBoost/boost/thread/csbl/tuple.hpp>
#include <LocalBoost/boost/thread/csbl/vector.hpp>
#endif
...
#include <LocalBoost/boost/thread/detail/atomic_undef_macros.hpp>
          if(!atomic_load(&future_))
            {
                future_ptr blank;
                atomic_compare_exchange(&future_,&blank,future_ptr(new detail::shared_state<R>));
            }
#include <LocalBoost/boost/thread/detail/atomic_redef_macros.hpp>
#endif
        }
