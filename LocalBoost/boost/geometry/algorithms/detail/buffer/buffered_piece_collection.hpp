...
#include <LocalBoost/boost/core/ignore_unused.hpp>
#include <LocalBoost/boost/range/begin.hpp>
#include <LocalBoost/boost/range/empty.hpp>
#include <LocalBoost/boost/range/end.hpp>
#include <LocalBoost/boost/range/size.hpp>
#include <LocalBoost/boost/range/value_type.hpp>

#include <LocalBoost/boost/geometry/core/assert.hpp>
...
#include <LocalBoost/boost/geometry/geometries/ring.hpp>

#include <LocalBoost/boost/geometry/algorithms/detail/buffer/buffered_ring.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/buffer/buffer_policies.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/cluster_info.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/buffer/get_piece_turns.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/buffer/piece_border.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/buffer/turn_in_piece_visitor.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/buffer/turn_in_original_visitor.hpp>

#include <LocalBoost/boost/geometry/algorithms/detail/disjoint/point_box.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/add_rings.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/assign_parents.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/enrichment_info.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/enrich_intersection_points.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/ring_properties.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/select_rings.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/traversal_info.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/traverse.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/overlay/turn_info.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/partition.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/sections/sectionalize.hpp>
#include <LocalBoost/boost/geometry/algorithms/detail/sections/section_box_policies.hpp>

#include <LocalBoost/boost/geometry/views/detail/closed_clockwise_view.hpp>
