...
#include <LocalBoost/boost/geometry/strategies/comparable_distance_result.hpp>
#include <LocalBoost/boost/geometry/strategies/default_comparable_distance_result.hpp>
