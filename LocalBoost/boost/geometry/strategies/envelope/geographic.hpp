...
#include <LocalBoost/boost/geometry/strategy/geographic/envelope.hpp> // Not used, for backward compatibility
#include <LocalBoost/boost/geometry/strategy/geographic/envelope_range.hpp>
