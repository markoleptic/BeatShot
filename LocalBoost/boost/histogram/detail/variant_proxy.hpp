...
#include <LocalBoost/boost/histogram/axis/traits.hpp> // variant_access
#include <LocalBoost/boost/histogram/detail/static_if.hpp>
#include <LocalBoost/boost/mp11/algorithm.hpp> // mp_with_index, mp_find, mp_at
#include <LocalBoost/boost/mp11/list.hpp>      // mp_size
