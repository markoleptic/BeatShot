...
#include <LocalBoost/boost/memory_order.hpp>
#include <LocalBoost/boost/atomic/detail/config.hpp>
#include <LocalBoost/boost/atomic/detail/intptr.hpp>
#include <LocalBoost/boost/atomic/detail/storage_traits.hpp>
#include <LocalBoost/boost/atomic/detail/bitwise_cast.hpp>
#include <LocalBoost/boost/atomic/detail/integral_conversions.hpp>
#include <LocalBoost/boost/atomic/detail/core_operations.hpp>
#include <LocalBoost/boost/atomic/detail/wait_operations.hpp>
#include <LocalBoost/boost/atomic/detail/extra_operations.hpp>
#include <LocalBoost/boost/atomic/detail/memory_order_utils.hpp>
#include <LocalBoost/boost/atomic/detail/aligned_variable.hpp>
#include <LocalBoost/boost/atomic/detail/type_traits/is_signed.hpp>
#include <LocalBoost/boost/atomic/detail/type_traits/is_nothrow_default_constructible.hpp>
#include <LocalBoost/boost/atomic/detail/type_traits/is_trivially_default_constructible.hpp>
#include <LocalBoost/boost/atomic/detail/type_traits/alignment_of.hpp>
#include <LocalBoost/boost/atomic/detail/type_traits/conditional.hpp>
#include <LocalBoost/boost/atomic/detail/type_traits/integral_constant.hpp>
#if !defined(BOOST_ATOMIC_NO_FLOATING_POINT)
#include <LocalBoost/boost/atomic/detail/bitwise_fp_cast.hpp>
#include <LocalBoost/boost/atomic/detail/fp_operations.hpp>
#include <LocalBoost/boost/atomic/detail/extra_fp_operations.hpp>
#endif
