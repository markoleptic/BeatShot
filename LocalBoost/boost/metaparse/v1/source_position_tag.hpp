...
#include <LocalBoost/boost/metaparse/v1/fwd/source_position.hpp>
#include <LocalBoost/boost/metaparse/v1/fwd/get_prev_char.hpp>
#include <LocalBoost/boost/metaparse/v1/fwd/next_line.hpp>
#include <LocalBoost/boost/metaparse/v1/fwd/next_char.hpp>
#include <LocalBoost/boost/metaparse/v1/get_col.hpp>
#include <LocalBoost/boost/metaparse/v1/get_line.hpp>
