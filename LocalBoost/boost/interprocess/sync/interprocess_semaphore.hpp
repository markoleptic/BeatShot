...
#include <LocalBoost/boost/interprocess/sync/detail/common_algorithms.hpp>
   ...
   #include <LocalBoost/boost/interprocess/sync/posix/semaphore.hpp>
   #define BOOST_INTERPROCESS_SEMAPHORE_USE_POSIX
#elif !defined(BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION) && defined (BOOST_INTERPROCESS_WINDOWS)
   //Experimental...
   #include <LocalBoost/boost/interprocess/sync/windows/semaphore.hpp>
   #define BOOST_INTERPROCESS_SEMAPHORE_USE_WINAPI
#else
   //spin_semaphore is used
   #include <LocalBoost/boost/interprocess/sync/spin/semaphore.hpp>
#endif
