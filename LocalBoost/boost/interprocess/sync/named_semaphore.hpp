...
#include <LocalBoost/boost/interprocess/sync/posix/named_semaphore.hpp>
//Experimental...
#elif !defined(BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION) && defined (BOOST_INTERPROCESS_WINDOWS)
   #include <LocalBoost/boost/interprocess/sync/windows/named_semaphore.hpp>
   #define BOOST_INTERPROCESS_NAMED_SEMAPHORE_USE_WINAPI
#else
   #include <LocalBoost/boost/interprocess/sync/shm/named_semaphore.hpp>
#endif
