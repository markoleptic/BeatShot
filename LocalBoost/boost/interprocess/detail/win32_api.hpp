...
#include <LocalBoost/boost/interprocess/detail/config_begin.hpp>
#include <LocalBoost/boost/interprocess/detail/workaround.hpp>
...
#  include <cstdarg>
#  include <LocalBoost/boost/detail/interlocked.hpp>
#else
...
#include <LocalBoost/boost/winapi/get_current_process_id.hpp>
#include <LocalBoost/boost/winapi/get_current_thread_id.hpp>
#include <LocalBoost/boost/winapi/get_current_process.hpp>
#include <LocalBoost/boost/winapi/get_process_times.hpp>
#include <LocalBoost/boost/winapi/error_codes.hpp>
#include <LocalBoost/boost/winapi/thread.hpp>
#include <LocalBoost/boost/winapi/system.hpp>
#include <LocalBoost/boost/winapi/time.hpp>
#include <LocalBoost/boost/winapi/timers.hpp>
#include <LocalBoost/boost/winapi/get_last_error.hpp>
#include <LocalBoost/boost/winapi/handles.hpp>
#include <LocalBoost/boost/winapi/file_management.hpp>
#include <LocalBoost/boost/winapi/mutex.hpp>
#include <LocalBoost/boost/winapi/wait.hpp>
#include <LocalBoost/boost/winapi/file_mapping.hpp>
#include <LocalBoost/boost/winapi/semaphore.hpp>
#include <LocalBoost/boost/winapi/system.hpp>
#include <LocalBoost/boost/winapi/error_handling.hpp>
#include <LocalBoost/boost/winapi/local_memory.hpp>
#include <LocalBoost/boost/winapi/directory_management.hpp>
#include <LocalBoost/boost/winapi/security.hpp>
#include <LocalBoost/boost/winapi/dll.hpp>
...
#include <LocalBoost/boost/interprocess/detail/config_end.hpp>
