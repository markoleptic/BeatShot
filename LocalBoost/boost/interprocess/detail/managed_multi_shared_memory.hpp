...
#include <LocalBoost/boost/interprocess/detail/managed_memory_impl.hpp>
#include <LocalBoost/boost/interprocess/creation_tags.hpp>
#include <LocalBoost/boost/core/no_exceptions_support.hpp>
#include <LocalBoost/boost/interprocess/detail/multi_segment_services.hpp>
#include <LocalBoost/boost/interprocess/detail/utilities.hpp>
#include <LocalBoost/boost/interprocess/shared_memory_object.hpp>
#include <LocalBoost/boost/interprocess/containers/list.hpp>//list
#include <LocalBoost/boost/interprocess/mapped_region.hpp> //mapped_region
#include <LocalBoost/boost/interprocess/shared_memory_object.hpp>
#include <LocalBoost/boost/interprocess/permissions.hpp>
#include <LocalBoost/boost/interprocess/detail/managed_open_or_create_impl.hpp> //managed_open_or_create_impl
#include <LocalBoost/boost/interprocess/containers/string.hpp>
#include <LocalBoost/boost/interprocess/streams/vectorstream.hpp>
...
#include <LocalBoost/boost/interprocess/mem_algo/rbtree_best_fit.hpp>
#include <LocalBoost/boost/interprocess/sync/mutex_family.hpp>
