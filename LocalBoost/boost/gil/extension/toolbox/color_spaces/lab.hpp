...
#include <LocalBoost/boost/gil/extension/toolbox/color_spaces/xyz.hpp>

#include <LocalBoost/boost/gil/color_convert.hpp>
#include <LocalBoost/boost/gil.hpp> // FIXME: Include what you use, not everything, even in extensions!
