...
#include <LocalBoost/boost/local_function/aux_/preprocessor/traits/decl_sign_/validate_/defaults.hpp>
#include <LocalBoost/boost/local_function/aux_/preprocessor/traits/decl_sign_/validate_/this.hpp>
