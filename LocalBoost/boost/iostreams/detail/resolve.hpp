...
#include <LocalBoost/boost/config.hpp> // partial spec, put size_t in std.
#include <cstddef>          // std::size_t.
#include <LocalBoost/boost/detail/is_incrementable.hpp>
#include <LocalBoost/boost/detail/workaround.hpp>
#include <LocalBoost/boost/iostreams/detail/adapter/mode_adapter.hpp>
#include <LocalBoost/boost/iostreams/detail/adapter/output_iterator_adapter.hpp>
#include <LocalBoost/boost/iostreams/detail/adapter/range_adapter.hpp>
#include <LocalBoost/boost/iostreams/detail/config/gcc.hpp>
#include <LocalBoost/boost/iostreams/detail/config/overload_resolution.hpp>
#include <LocalBoost/boost/iostreams/detail/config/wide_streams.hpp>
#include <LocalBoost/boost/iostreams/detail/enable_if_stream.hpp>
#include <LocalBoost/boost/iostreams/detail/is_dereferenceable.hpp>
#include <LocalBoost/boost/iostreams/detail/is_iterator_range.hpp>
#include <LocalBoost/boost/iostreams/detail/select.hpp>
#include <LocalBoost/boost/iostreams/detail/wrap_unwrap.hpp>
#include <LocalBoost/boost/iostreams/device/array.hpp>
#include <LocalBoost/boost/iostreams/traits.hpp>
#include <LocalBoost/boost/mpl/and.hpp>
#include <LocalBoost/boost/mpl/bool.hpp> // true_.
...
// Must come last.
#include <LocalBoost/boost/iostreams/detail/config/disable_warnings.hpp> // VC7.1 C4224.
...
#include <LocalBoost/boost/iostreams/detail/config/enable_warnings.hpp> // VC7.1 4224.
