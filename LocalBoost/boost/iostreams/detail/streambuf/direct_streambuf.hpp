...
#include <LocalBoost/boost/config.hpp>                        // BOOST_DEDUCED_TYPENAME, 
#include <LocalBoost/boost/core/typeinfo.hpp>
#include <LocalBoost/boost/iostreams/detail/char_traits.hpp>  // member template friends.
#include <LocalBoost/boost/iostreams/detail/config/wide_streams.hpp>
#include <LocalBoost/boost/iostreams/detail/error.hpp>
...
#include <LocalBoost/boost/iostreams/detail/streambuf.hpp>
...
// Must come last.
#include <LocalBoost/boost/iostreams/detail/config/disable_warnings.hpp> // MSVC.
...
#include <LocalBoost/boost/iostreams/detail/config/enable_warnings.hpp> // MSVC
