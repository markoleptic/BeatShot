...
#include <LocalBoost/boost/config.hpp>       // SFINAE, MSVC, put ptrdiff_t in std.
#include <algorithm>              // copy, min.
#include <cstddef>                // ptrdiff_t.
#include <LocalBoost/boost/detail/workaround.hpp>
#include <LocalBoost/boost/iostreams/categories.hpp>
#include <LocalBoost/boost/iostreams/detail/config/limits.hpp>        // forwarding.
#include <LocalBoost/boost/iostreams/detail/config/wide_streams.hpp>  // locale.
#include <LocalBoost/boost/iostreams/detail/double_object.hpp>
#include <LocalBoost/boost/iostreams/detail/error.hpp>
#include <LocalBoost/boost/iostreams/detail/ios.hpp>  // openmode, seekdir, int types.
...
// Must come last.
#include <LocalBoost/boost/iostreams/detail/config/disable_warnings.hpp> // VC7.1
