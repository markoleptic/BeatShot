...
#include <LocalBoost/boost/config.hpp>                 // Make sure ptrdiff_t is in std.
#include <algorithm>                        // copy, min.
#include <cstddef>                          // ptrdiff_t.
#include <utility>                          // pair.

#include <LocalBoost/boost/detail/workaround.hpp>
#include <LocalBoost/boost/iostreams/chain.hpp>
...
#include <LocalBoost/boost/iostreams/detail/resolve.hpp>                   
#include <LocalBoost/boost/iostreams/detail/wrap_unwrap.hpp>
#include <LocalBoost/boost/iostreams/operations.hpp>  // read, write, close.
