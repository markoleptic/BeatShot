...
#include <LocalBoost/boost/config.hpp> // STATIC_CONSTANT, STDC_NAMESPACE, 
...
#include <LocalBoost/boost/config.hpp>               // Put size_t in std.
#include <LocalBoost/boost/detail/workaround.hpp>
#include <LocalBoost/boost/cstdint.hpp>              // uint8_t, uint32_t.
#include <LocalBoost/boost/iostreams/checked_operations.hpp>
#include <LocalBoost/boost/iostreams/constants.hpp>  // buffer size.
#include <LocalBoost/boost/iostreams/detail/adapter/non_blocking_adapter.hpp>
#include <LocalBoost/boost/iostreams/detail/adapter/range_adapter.hpp>
#include <LocalBoost/boost/iostreams/detail/char_traits.hpp>
#include <LocalBoost/boost/iostreams/detail/ios.hpp> // failure, streamsize.
#include <LocalBoost/boost/iostreams/detail/error.hpp>
#include <LocalBoost/boost/iostreams/operations.hpp>
#include <LocalBoost/boost/iostreams/device/back_inserter.hpp>
#include <LocalBoost/boost/iostreams/filter/zlib.hpp>
#include <LocalBoost/boost/iostreams/pipeline.hpp>     
#include <LocalBoost/boost/iostreams/putback.hpp>
