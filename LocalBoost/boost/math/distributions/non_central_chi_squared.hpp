...
#include <LocalBoost/boost/math/distributions/fwd.hpp>
#include <LocalBoost/boost/math/special_functions/gamma.hpp> // for incomplete gamma. gamma_q
#include <LocalBoost/boost/math/special_functions/bessel.hpp> // for cyl_bessel_i
#include <LocalBoost/boost/math/special_functions/round.hpp> // for iround
#include <LocalBoost/boost/math/distributions/complement.hpp> // complements
#include <LocalBoost/boost/math/distributions/chi_squared.hpp> // central distribution
#include <LocalBoost/boost/math/distributions/detail/common_error_handling.hpp> // error checks
#include <LocalBoost/boost/math/special_functions/fpclassify.hpp> // isnan.
#include <LocalBoost/boost/math/tools/roots.hpp> // for root finding.
#include <LocalBoost/boost/math/distributions/detail/generic_mode.hpp>
#include <LocalBoost/boost/math/distributions/detail/generic_quantile.hpp>
...
#include <LocalBoost/boost/math/distributions/detail/derived_accessors.hpp>
