...
#include <LocalBoost/boost/math/special_functions/beta.hpp> // for incomplete beta.
...
#include <LocalBoost/boost/math/distributions/detail/inv_discrete_quantile.hpp> // error checks
