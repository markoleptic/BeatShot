...
#include <LocalBoost/boost/math/special_functions/log1p.hpp> // for log (1 + x)
#include <LocalBoost/boost/math/constants/constants.hpp> // For exp_minus_one == 3.67879441171442321595523770161460867e-01.
#include <LocalBoost/boost/math/special_functions/pow.hpp> // powers with compile time exponent, used in arbitrary precision code.
#include <LocalBoost/boost/math/tools/series.hpp> // series functor.
//#include <LocalBoost/boost/math/tools/polynomial.hpp>  // polynomial.
#include <LocalBoost/boost/math/tools/rational.hpp>  // evaluate_polynomial.
#include <LocalBoost/boost/math/tools/precision.hpp> // boost::math::tools::max_value().
#include <LocalBoost/boost/math/tools/big_constant.hpp>
#include <LocalBoost/boost/math/tools/cxx03_warn.hpp>
...
#include <iostream>
#include <typeinfo>
#include <LocalBoost/boost/math/special_functions/next.hpp>  // For float_distance.
...
#include <LocalBoost/boost/math/special_functions/detail/lambert_w_lookup_table.ipp>
