...
#include <LocalBoost/boost/qvm/detail/quat_assign.hpp>
#include <LocalBoost/boost/qvm/deduce_quat.hpp>
#include <LocalBoost/boost/qvm/mat_traits.hpp>
#include <LocalBoost/boost/qvm/scalar_traits.hpp>
#include <LocalBoost/boost/qvm/math.hpp>
#include <LocalBoost/boost/qvm/assert.hpp>
#include <LocalBoost/boost/qvm/error.hpp>
#include <LocalBoost/boost/qvm/throw_exception.hpp>
#include <string>
#include <cmath>
