...
#include <LocalBoost/boost/mpi/config.hpp>
#include <LocalBoost/boost/mpi/exception.hpp>
...
#include <LocalBoost/boost/mpi/packed_oarchive.hpp>
#include <LocalBoost/boost/mpi/packed_iarchive.hpp>

// For (de-)serializing skeletons and content
#include <LocalBoost/boost/mpi/skeleton_and_content_fwd.hpp>

#include <LocalBoost/boost/mpi/detail/point_to_point.hpp>
#include <LocalBoost/boost/mpi/status.hpp>
#include <LocalBoost/boost/mpi/request.hpp>
...
#include <LocalBoost/boost/mpi/detail/request_handlers.hpp>
...
#  include <LocalBoost/boost/mpi/detail/communicator_sc.hpp>
#endif
