...
#include <LocalBoost/boost/locale/config.hpp>
#include <LocalBoost/boost/locale/encoding_errors.hpp>
#include <LocalBoost/boost/locale/encoding_utf.hpp>
#include <LocalBoost/boost/locale/info.hpp>
#include <LocalBoost/boost/locale/util/string.hpp>
