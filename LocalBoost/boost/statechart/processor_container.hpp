...
#include <LocalBoost/boost/statechart/event_base.hpp>
#include <LocalBoost/boost/statechart/event_processor.hpp>
...
#include <LocalBoost/boost/bind.hpp>
#include <LocalBoost/boost/config.hpp> // BOOST_INTEL
