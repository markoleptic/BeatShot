...
#include <LocalBoost/boost/statechart/fifo_worker.hpp>
#include <LocalBoost/boost/statechart/processor_container.hpp>

#include <LocalBoost/boost/intrusive_ptr.hpp>
#include <LocalBoost/boost/noncopyable.hpp>
#include <LocalBoost/boost/config.hpp> // BOOST_HAS_THREADS
