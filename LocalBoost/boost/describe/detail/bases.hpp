...
#include <LocalBoost/boost/describe/detail/compute_base_modifiers.hpp>
#include <LocalBoost/boost/describe/detail/pp_for_each.hpp>
#include <LocalBoost/boost/describe/detail/list.hpp>
#include <type_traits>
