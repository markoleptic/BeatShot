...
#include <LocalBoost/boost/iterator/iterator_adaptor.hpp> // for enable_if_convertible
#include <LocalBoost/boost/iterator/iterator_categories.hpp>

#include <LocalBoost/boost/iterator/minimum_category.hpp>

#include <utility> // for std::pair
#include <LocalBoost/boost/fusion/adapted/boost_tuple.hpp> // for backward compatibility
...
#include <LocalBoost/boost/fusion/sequence/convert.hpp>
#include <LocalBoost/boost/fusion/sequence/intrinsic/at_c.hpp>
#include <LocalBoost/boost/fusion/sequence/comparison/equal_to.hpp>
