...
#include <LocalBoost/boost/pointee.hpp>
#include <LocalBoost/boost/indirect_reference.hpp>
...
#include <LocalBoost/boost/iterator/detail/config_def.hpp> // must be last #include
