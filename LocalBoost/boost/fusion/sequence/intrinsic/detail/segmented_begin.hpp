...
#include <LocalBoost/boost/fusion/sequence/intrinsic/detail/segmented_begin_impl.hpp>
#include <LocalBoost/boost/fusion/iterator/segmented_iterator.hpp>
...
#include <LocalBoost/boost/fusion/container/list/cons.hpp>
