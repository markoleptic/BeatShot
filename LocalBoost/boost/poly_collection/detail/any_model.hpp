...
#include <LocalBoost/boost/mpl/map/map10.hpp>
#include <LocalBoost/boost/mpl/pair.hpp>
#include <LocalBoost/boost/mpl/vector/vector10.hpp>
#include <LocalBoost/boost/poly_collection/detail/any_iterator.hpp>
#include <LocalBoost/boost/poly_collection/detail/is_acceptable.hpp>
#include <LocalBoost/boost/poly_collection/detail/segment_backend.hpp>
#include <LocalBoost/boost/poly_collection/detail/split_segment.hpp>
#include <LocalBoost/boost/type_erasure/any.hpp>
#include <LocalBoost/boost/type_erasure/any_cast.hpp>
#include <LocalBoost/boost/type_erasure/binding.hpp>
#include <LocalBoost/boost/type_erasure/builtin.hpp>
#include <LocalBoost/boost/type_erasure/concept_of.hpp>
#include <LocalBoost/boost/type_erasure/is_subconcept.hpp>
#include <LocalBoost/boost/type_erasure/relaxed.hpp>
#include <LocalBoost/boost/type_erasure/static_binding.hpp>
#include <LocalBoost/boost/type_erasure/typeid_of.hpp>
#include <memory>
#include <type_traits>
#include <typeinfo>
#include <utility>
