...
#include <LocalBoost/boost/config.hpp> // msvc 6.0 needs this to suppress warnings
#ifndef BOOST_NO_STD_WSTREAMBUF

#include <LocalBoost/boost/assert.hpp>
#include <algorithm> // std::copy
#include <LocalBoost/boost/detail/workaround.hpp> // Dinkumware and RogueWave
#if BOOST_WORKAROUND(BOOST_DINKUMWARE_STDLIB, == 1)
#include <LocalBoost/boost/archive/dinkumware.hpp>
#endif
...
#include <LocalBoost/boost/serialization/string.hpp>

#include <LocalBoost/boost/archive/basic_xml_archive.hpp>
#include <LocalBoost/boost/archive/xml_wiarchive.hpp>

#include <LocalBoost/boost/archive/xml_archive_exception.hpp>
#include <LocalBoost/boost/archive/iterators/mb_from_wchar.hpp>

#include <LocalBoost/boost/archive/detail/utf8_codecvt_facet.hpp>
