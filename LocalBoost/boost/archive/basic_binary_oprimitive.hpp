...
#include <LocalBoost/boost/scoped_ptr.hpp>
#include <LocalBoost/boost/serialization/throw_exception.hpp>

#include <LocalBoost/boost/serialization/is_bitwise_serializable.hpp>
#include <LocalBoost/boost/serialization/array_wrapper.hpp>

#include <LocalBoost/boost/archive/basic_streambuf_locale_saver.hpp>
#include <LocalBoost/boost/archive/codecvt_null.hpp>
#include <LocalBoost/boost/archive/archive_exception.hpp>
#include <LocalBoost/boost/archive/detail/auto_link_archive.hpp>
#include <LocalBoost/boost/archive/detail/abi_prefix.hpp> // must be the last header
...
#include <LocalBoost/boost/archive/detail/abi_suffix.hpp> // pop pragmas
