...
#include <LocalBoost/boost/smart_ptr/scoped_ptr.hpp>
#include <LocalBoost/boost/archive/detail/auto_link_warchive.hpp>
#include <LocalBoost/boost/archive/basic_text_iprimitive.hpp>
#include <LocalBoost/boost/archive/basic_xml_iarchive.hpp>
