...
#include <LocalBoost/boost/nowide/detail/is_string_container.hpp>
#include <LocalBoost/boost/nowide/replacement.hpp>
#include <LocalBoost/boost/nowide/utf/utf.hpp>
#include <iterator>
#include <string>
