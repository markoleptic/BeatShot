...
#   include <LocalBoost/boost/leaf/config/tls_freertos.hpp>
#endif
...
#   include <LocalBoost/boost/leaf/config/tls_array.hpp>
#elif defined(BOOST_LEAF_NO_THREADS)
#   include <LocalBoost/boost/leaf/config/tls_globals.hpp>
#else
#   include <LocalBoost/boost/leaf/config/tls_cpp11.hpp>
#endif
