...
#include <LocalBoost/boost/chrono/detail/static_assert.hpp>
...
#include <LocalBoost/boost/ratio/ratio.hpp>
...
#include <LocalBoost/boost/chrono/detail/is_evenly_divisible_by.hpp>
...
#include <LocalBoost/boost/config/abi_prefix.hpp> // must be the last #include
#endif
...
#include <LocalBoost/boost/config/abi_suffix.hpp> // pops abi_prefix.hpp pragmas
#endif
