...
#include <LocalBoost/boost/typeof/constant.hpp>
#include <LocalBoost/boost/preprocessor/iteration/self.hpp>
...
#     include <LocalBoost/boost/preprocessor/repeat_from_to.hpp>
