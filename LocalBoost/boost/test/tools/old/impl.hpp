...
#include <LocalBoost/boost/test/tools/floating_point_comparison.hpp>
...
#include <LocalBoost/boost/numeric/conversion/conversion_traits.hpp> // for numeric::conversion_traits
