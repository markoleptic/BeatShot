...
// Boost
#include <LocalBoost/boost/cstdlib.hpp>    // for exit codes
#include <LocalBoost/boost/config.hpp>     // for workarounds
#include <LocalBoost/boost/core/ignore_unused.hpp> // for ignore_unused
#ifndef BOOST_NO_EXCEPTIONS
#include <LocalBoost/boost/exception/get_error_info.hpp> // for get_error_info
#include <LocalBoost/boost/exception/current_exception_cast.hpp> // for current_exception_cast
#include <LocalBoost/boost/exception/diagnostic_information.hpp>
#endif
...
#  include <LocalBoost/boost/core/demangle.hpp>
#endif
