...
// Boost.Test
#include <LocalBoost/boost/test/framework.hpp>
#include <LocalBoost/boost/test/execution_monitor.hpp>
#include <LocalBoost/boost/test/debug.hpp>
#include <LocalBoost/boost/test/unit_test_parameters.hpp>

#include <LocalBoost/boost/test/unit_test_log.hpp>
#include <LocalBoost/boost/test/unit_test_log_formatter.hpp>
#include <LocalBoost/boost/test/unit_test_monitor.hpp>
#include <LocalBoost/boost/test/results_collector.hpp>
#include <LocalBoost/boost/test/progress_monitor.hpp>
#include <LocalBoost/boost/test/results_reporter.hpp>
#include <LocalBoost/boost/test/test_framework_init_observer.hpp>

#include <LocalBoost/boost/test/tree/observer.hpp>
#include <LocalBoost/boost/test/tree/test_unit.hpp>
#include <LocalBoost/boost/test/tree/visitor.hpp>
#include <LocalBoost/boost/test/tree/traverse.hpp>
#include <LocalBoost/boost/test/tree/test_case_counter.hpp>
#include <LocalBoost/boost/test/tree/global_fixture.hpp>

#if BOOST_TEST_SUPPORT_TOKEN_ITERATOR
#include <LocalBoost/boost/test/utils/iterator/token_iterator.hpp>
#endif

#include <LocalBoost/boost/test/utils/foreach.hpp>
#include <LocalBoost/boost/test/utils/basic_cstring/io.hpp>
#include <LocalBoost/boost/test/utils/basic_cstring/compare.hpp>

#include <LocalBoost/boost/test/detail/global_typedef.hpp>
#include <LocalBoost/boost/test/detail/throw_exception.hpp>

// Boost
#include <LocalBoost/boost/test/utils/timer.hpp>
...
#include <LocalBoost/boost/test/detail/suppress_warnings.hpp>
...
#include <LocalBoost/boost/test/detail/enable_warnings.hpp>
