...
#include <LocalBoost/boost/callable_traits/detail/core.hpp>
#include <LocalBoost/boost/callable_traits/detail/is_invocable_impl.hpp>
...
[heading Header]
``#include <LocalBoost/boost/callable_traits/is_invocable.hpp>``
[heading Definition]
*/
