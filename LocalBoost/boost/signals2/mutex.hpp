...
# include <LocalBoost/boost/signals2/detail/lwm_nop.hpp>
#elif defined(BOOST_HAS_PTHREADS)
#  include <LocalBoost/boost/signals2/detail/lwm_pthreads.hpp>
#elif defined(BOOST_HAS_WINTHREADS)
#  include <LocalBoost/boost/signals2/detail/lwm_win32_cs.hpp>
#else
