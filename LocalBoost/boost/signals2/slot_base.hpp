...
#include <LocalBoost/boost/signals2/detail/foreign_ptr.hpp>
#include <LocalBoost/boost/signals2/expired_slot.hpp>
#include <LocalBoost/boost/signals2/signal_base.hpp>
