...
#include <LocalBoost/boost/compute/algorithm/copy.hpp>
#include <LocalBoost/boost/compute/algorithm/fill.hpp>
#include <LocalBoost/boost/compute/algorithm/max_element.hpp>
#include <LocalBoost/boost/compute/algorithm/min_element.hpp>
#include <LocalBoost/boost/compute/algorithm/transform.hpp>
#include <LocalBoost/boost/compute/algorithm/accumulate.hpp>
#include <LocalBoost/boost/compute/detail/buffer_value.hpp>
#include <LocalBoost/boost/compute/functional.hpp>
#include <LocalBoost/boost/compute/functional/bind.hpp>
