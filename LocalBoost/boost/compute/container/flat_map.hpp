...
#include <LocalBoost/boost/compute/algorithm/find.hpp>
#include <LocalBoost/boost/compute/algorithm/lower_bound.hpp>
#include <LocalBoost/boost/compute/algorithm/upper_bound.hpp>
...
#include <LocalBoost/boost/compute/types/pair.hpp>
