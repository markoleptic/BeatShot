...
#include <LocalBoost/boost/iterator/iterator_traits.hpp> // iterator_difference
...
#include <LocalBoost/boost/preprocessor/list/for_each.hpp>
...
#include <LocalBoost/boost/range/size_type.hpp>
...
#include <LocalBoost/boost/utility/enable_if.hpp> // disable_if
#include <LocalBoost/boost/next_prior.hpp>

#if !defined(BOOST_RANGE_DETAIL_MICROSOFT_RANGE_VERSION_1)
    #include <LocalBoost/boost/range/mutable_iterator.hpp>
#else
...
#include <LocalBoost/boost/iterator/iterator_categories.hpp>
...
#include <LocalBoost/boost/range/mutable_iterator.hpp>
#include <LocalBoost/boost/range/rbegin.hpp>
#include <LocalBoost/boost/range/rend.hpp>
