...
# include <LocalBoost/boost/python/ptr.hpp>
# include <LocalBoost/boost/python/tag.hpp>
# include <LocalBoost/boost/python/to_python_indirect.hpp>

# include <LocalBoost/boost/python/converter/registered.hpp>
# include <LocalBoost/boost/python/converter/registered_pointee.hpp>
# include <LocalBoost/boost/python/converter/arg_to_python_base.hpp>
# include <LocalBoost/boost/python/converter/shared_ptr_to_python.hpp>
// Bring in specializations
# include <LocalBoost/boost/python/converter/builtin_converters.hpp>

# include <LocalBoost/boost/python/object/function_handle.hpp>

# include <LocalBoost/boost/python/base_type_traits.hpp>

# include <LocalBoost/boost/python/detail/indirect_traits.hpp>
# include <LocalBoost/boost/python/detail/convertible.hpp>
# include <LocalBoost/boost/python/detail/string_literal.hpp>
# include <LocalBoost/boost/python/detail/value_is_shared_ptr.hpp>
