...
#include <LocalBoost/boost/python/numpy/dtype.hpp>
#include <LocalBoost/boost/python/numpy/ndarray.hpp>
#include <LocalBoost/boost/python/numpy/scalars.hpp>
#include <LocalBoost/boost/python/numpy/matrix.hpp>
#include <LocalBoost/boost/python/numpy/ufunc.hpp>
#include <LocalBoost/boost/python/numpy/invoke_matching.hpp>
#include <LocalBoost/boost/python/numpy/config.hpp>
