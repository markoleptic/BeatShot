...
# include <LocalBoost/boost/python/detail/prefix.hpp>

# include <LocalBoost/boost/noncopyable.hpp>

# include <LocalBoost/boost/python/class_fwd.hpp>
# include <LocalBoost/boost/python/object/class.hpp>

# include <LocalBoost/boost/python/object.hpp>
# include <LocalBoost/boost/python/type_id.hpp>
# include <LocalBoost/boost/python/data_members.hpp>
# include <LocalBoost/boost/python/make_function.hpp>
# include <LocalBoost/boost/python/signature.hpp>
# include <LocalBoost/boost/python/init.hpp>
# include <LocalBoost/boost/python/args_fwd.hpp>

# include <LocalBoost/boost/python/object/class_metadata.hpp>
# include <LocalBoost/boost/python/object/pickle_support.hpp>
# include <LocalBoost/boost/python/object/add_to_namespace.hpp>

# include <LocalBoost/boost/python/detail/overloads_fwd.hpp>
# include <LocalBoost/boost/python/detail/operator_id.hpp>
# include <LocalBoost/boost/python/detail/def_helper.hpp>
# include <LocalBoost/boost/python/detail/force_instantiate.hpp>
# include <LocalBoost/boost/python/detail/type_traits.hpp>
# include <LocalBoost/boost/python/detail/unwrap_type_id.hpp>
# include <LocalBoost/boost/python/detail/unwrap_wrapper.hpp>

# include <LocalBoost/boost/mpl/size.hpp>
# include <LocalBoost/boost/mpl/for_each.hpp>
