...
#include <LocalBoost/boost/preprocessor.hpp>
#include <LocalBoost/boost/parameter/is_argument_pack.hpp>
#include <LocalBoost/boost/parameter/name.hpp>
...
#include <LocalBoost/boost/property_map/shared_array_property_map.hpp>
