...
#include <LocalBoost/boost/config.hpp> //for std::min macros
...
#include <LocalBoost/boost/graph/planar_detail/face_handles.hpp>
#include <LocalBoost/boost/graph/planar_detail/face_iterators.hpp>
#include <LocalBoost/boost/graph/planar_detail/bucket_sort.hpp>
