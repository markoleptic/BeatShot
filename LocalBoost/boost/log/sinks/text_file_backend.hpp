...
#include <LocalBoost/boost/optional/optional.hpp>
#include <LocalBoost/boost/smart_ptr/shared_ptr.hpp>
#include <LocalBoost/boost/date_time/date_defs.hpp>
#include <LocalBoost/boost/date_time/special_defs.hpp>
#include <LocalBoost/boost/date_time/gregorian/greg_day.hpp>
#include <LocalBoost/boost/date_time/posix_time/posix_time_types.hpp>
#include <LocalBoost/boost/filesystem/path.hpp>
#include <LocalBoost/boost/log/keywords/max_size.hpp>
#include <LocalBoost/boost/log/keywords/max_files.hpp>
#include <LocalBoost/boost/log/keywords/min_free_space.hpp>
#include <LocalBoost/boost/log/keywords/target.hpp>
#include <LocalBoost/boost/log/keywords/target_file_name.hpp>
#include <LocalBoost/boost/log/keywords/file_name.hpp>
#include <LocalBoost/boost/log/keywords/open_mode.hpp>
#include <LocalBoost/boost/log/keywords/auto_flush.hpp>
#include <LocalBoost/boost/log/keywords/rotation_size.hpp>
#include <LocalBoost/boost/log/keywords/time_based_rotation.hpp>
#include <LocalBoost/boost/log/keywords/enable_final_rotation.hpp>
#include <LocalBoost/boost/log/keywords/auto_newline_mode.hpp>
...
#include <LocalBoost/boost/log/sinks/auto_newline_mode.hpp>
#include <LocalBoost/boost/log/sinks/basic_sink_backend.hpp>
#include <LocalBoost/boost/log/sinks/frontend_requirements.hpp>
