...
#include <LocalBoost/boost/log/attributes/attribute_set.hpp>
...
#include <LocalBoost/boost/log/sources/features.hpp>
#include <LocalBoost/boost/log/sources/threading_models.hpp>
