...
#include <LocalBoost/boost/dll/config.hpp>
#include <LocalBoost/boost/predef/os.h>
...
#include <LocalBoost/boost/dll/detail/system_error.hpp>
#include <LocalBoost/boost/dll/detail/aggressive_ptr_cast.hpp>

#if BOOST_OS_WINDOWS
#   include <LocalBoost/boost/dll/detail/windows/shared_library_impl.hpp>
#else
#   include <LocalBoost/boost/dll/detail/posix/shared_library_impl.hpp>
#endif
