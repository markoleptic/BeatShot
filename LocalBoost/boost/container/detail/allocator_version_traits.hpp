...
#include <LocalBoost/boost/container/detail/multiallocation_chain.hpp> //multiallocation_chain
#include <LocalBoost/boost/container/detail/version_type.hpp>          //version_type
#include <LocalBoost/boost/container/detail/allocation_type.hpp>       //allocation_type
#include <LocalBoost/boost/container/detail/mpl.hpp>                   //integral_constant
#include <LocalBoost/boost/intrusive/pointer_traits.hpp>               //pointer_traits
#include <LocalBoost/boost/core/no_exceptions_support.hpp>             //BOOST_TRY
