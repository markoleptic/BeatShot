...
#include <LocalBoost/boost/algorithm/string/config.hpp>
#include <algorithm>
#include <iterator>
...
#include <LocalBoost/boost/algorithm/string/concept.hpp>
#include <LocalBoost/boost/algorithm/string/find_iterator.hpp>
#include <LocalBoost/boost/algorithm/string/detail/util.hpp>
