...
#include <LocalBoost/boost/integer_fwd.hpp>  // self include

#include <LocalBoost/boost/integer_traits.hpp>  // for boost::::boost::integer_traits
#include <LocalBoost/boost/limits.hpp>          // for ::std::numeric_limits
#include <LocalBoost/boost/cstdint.hpp>         // for boost::int64_t and BOOST_NO_INTEGRAL_INT64_T
